...
<meta name="keywords" content='airmail, airmail board, cargo, universal postal union, upu, lithium batteries, parcel, e-commerce, dangerous goods, post, ' />
<meta name="description" content="The Airmail Board is responsible for all matters dealing with the movement of mail cargo by air" /><meta name="robots" content="FOLLOW,INDEX" /><meta name="language" content="English" /><title>
		
    
        IATA - Air Mail Board (AMB) 
...
<meta property='og:title' content='Air Mail Board (AMB)'>
<meta property='og:type' content='website'>
<meta property='og:url' content='https://www.iata.org/whatwedo/workgroups/pages/amb.aspx'>
...
var guaGmtGlobalRequestUri = "/whatwedo/workgroups/Pages/amb.aspx";
var guaGmtGlobalPageTitle = "Air Mail Board (AMB)";
...
'page' : {
'requestURI' : "/whatwedo/workgroups/Pages/amb.aspx",
'pageType' : "Home",
'device' : "Desktop",
...
<form method="post" action="./amb.aspx" id="aspnetForm">
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
...
var _fV4UI=true;var _spPageContextInfo = {webServerRelativeUrl: "\u002fwhatwedo\u002fworkgroups", webAbsoluteUrl: "https:\u002f\u002fwww.iata.org\u002fwhatwedo\u002fworkgroups", siteAbsoluteUrl: "https:\u002f\u002fwww.iata.org", serverRequestPath: "\u002fwhatwedo\u002fworkgroups\u002fPages\u002famb.aspx", layoutsUrl: "_layouts\u002f15", webTitle: "Workgroups", webTemplate: "10020", tenantAppVersion: "0", isAppWeb: false, Has2019Era: true, webLogoUrl: "\u002f_layouts\u002fimages\u002ftitlegraphic.gif", webLanguage: 1033, currentLanguage: 1033, currentUICultureName: "en-US", currentCultureName: "en-US", clientServerTimeDelta: new Date("2019-11-27T19:23:39.1007927Z") - new Date(), siteClientTag: "367$$15.0.5127.1000", crossDomainPhotosEnabled:false, webUIVersion:15, webPermMasks:{High:16,Low:196705},pageListId:"{67d3e7a9-4552-4e1b-b2aa-c11911aeaabd}",pageItemId:148, pagePersonalizationScope:1, alertsEnabled:true, siteServerRelativeUrl: "\u002f", allowSilverlightPrompt:'True'};document.onreadystatechange=fnRemoveAllStatus; function fnRemoveAllStatus(){removeAllStatus(true)};//]]>
</script>
...
<script language="javascript">
    ...
    function GACode() {
        ...
        _gaq.push(['_trackPageview', '/whatwedo/workgroups/Pages/amb.aspx?q=' + document.getElementById("SearchTextBox").value + '&cat=Main_Search']);
        */
        return true;
    }
...
<ul>
<li><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fwww.iata.org%2Fwhatwedo%2Fworkgroups%2Fpages%2Famb.aspx" id="ctl00_PlaceHolderMain_pageTools_linkFB" target="_blank" title="Share this Page"><span class="icon icon-facebook"></span></a></li>
...
<li><a href="//www.linkedin.com/shareArticle?mini=true&url=http%3A%2F%2Fwww.iata.org%2Fwhatwedo%2Fworkgroups%2FPages%2Famb.aspx" id="ctl00_PlaceHolderMain_pageTools_linkLinkedIn" target="_blank"><span class="icon icon-linkedin"></span></a></li>
<li><a href="mailto:?subject=I wanted you to see this site&amp;body=Check out this site http://www.iata.org/whatwedo/workgroups/Pages/amb.aspx" id="ctl00_PlaceHolderMain_pageTools_linkMail" title="Share by Email"><span class="icon icon-enveloppeRound"></span></a></li>
</ul>
</div>
</div>
</div>
...
<span>
<div class="zHighlight"><div class="zHighlightBox"><h2>Electronic data interchange (EDI)<br></h2><p>Check out the new joint&#160;<a href="/whatwedo/workgroups/Documents/edi-brochure.pdf" target="_blank">UPU-IATA-IPC Brochure</a>&#160;(pdf) promoting the use of electronic data interchange (EDI) in the air mail business.&#160;<br></p></div></div>&#160; </span></div></div></div></span>
<p>
<span>These collaborative efforts have produced&#58;</span><br></p><ul><li>A model&#160;<a href="/whatwedo/workgroups/Documents/amp-framework-postal-service-agreement.pdf" target="_blank">Framework for a Postal Service Agreement</a>&#160;(pdf) that is a template setting out standard provisions on the technical and liability aspects of a bilateral agreement between an airline and a Designated Postal Operator (DPO)&#160;to provide transportation services for mail</li><li>
...
<a href="/publications/store/pages/airport-handling-manual.aspx">Airport Handling Manual</a>, 37th Edition in&#160;2017</span></li><li>
<span>Multiple options for sending security data to customs at destination in regards to the upcoming requirement from the European Commission to file the pre-arrival
<a href="/whatwedo/cargo/fal/pages/index.aspx">Advance Cargo Information</a>&#160;(ACI)</span></li><li>
<span>The&#160;</span><a href="/whatwedo/workgroups/Documents/iata-pawb-functionalspecs-v1.0.pdf" target="_blank">Guidelines for the use of the Postal Air Waybill (PAWB) number</a><span>&#160;(pdf)&#160;that will hopefully help bridge the gap between mail and cargo</span></li></ul><h3 class="iataElement-Title3">
<span>Objectives</span></h3><div>
<span>A</span><span>MB&#160;develops and maintains standards, guidelines and procedures related to the carriage of air mail&#58;</span>
<div><ul><li>It promotes the use of EDI&#160;in the air mail business</li><li>
<span lang="EN">Creation of joint workshop with the UPU for the mapping of CARDIT and FWB messages</span></li><li>It provides guidelines for the use of the Postal Air Waybill number</li><li>It includes a requirements for the&#160;parties involved to&#160;ensure that no explosive,&#160;incendiary and prohibited items are inserted in the mail</li><li>It&#160;defines safety requirements, especially referring to Lithium Batteries in air mail</li><li>It clarifies security and customs requirements, such as the provision of ACI&#160;<span lang="EN">and help carriers to implement the most effective solution for sending pre-arrival ACI</span></li><li>It asks the required parties to cooperate in the development of training programs and awareness</li><li><p>
<span lang="EN">It ensures collaboration with the UPU for responding efficiently to the demand for eCommerce solutions (Track &amp; Trace, Capacity, Booking…etc.)</span></p></li></ul><p>The standards and procedures developed by the AMB&#160;are included as recommendations in the IATA’s Airport Handling Manual.<br></p><h3 class="iataElement-Title3">Postal Account Settlement System (PASS)<br></h3><p>IATA, together with airlines and global post offices are pursuing a new initiative for a
<a href="/whatwedo/airline-distribution/Pages/pass.aspx">Postal Accounts Settlement System (PASS)</a>.&#160;</p><p>The objective is to provide an automated industry platform to process the large volume of airlines-postal billings and settlements that today are processed bilaterally and largely manually. The new solution will capitalize on IATA’s strong financial services knowledge and expertise, as well as existing solutions for simplified billing and settlement of the supply chain’s stakeholders.&#160;</p><p>Successful implementation of the PASS system will facilitate the invoicing and payment for mail and other related services. It will simplify current processes, standardize both invoicing and the exchange of data. Other benefits include a reduction in time-consuming manual processes, easier identification of duplicate transactions and easier facilitation of online dispute resolution.&#160;</p><p>PASS will enable Airlines to work more efficiently with Postal companies and generate new business opportunities for the industry.<br></p><h3 class="iataElement-Title3">Meeting schedule</h3><p>The AMB&#160;normally meets&#160;twice a year&#58; in March&#160;at&#160;the IATA World Cargo Symposium (WCS) and in October at the UPU Conference in Berne.</p><h3 class="iataElement-Title3">Membership</h3><p>The AMB&#160;consists of up to 12 Members appointed by the
<a href="/whatwedo/workgroups/Pages/csc.aspx">Cargo Services Conference (CSC)</a>, each being an expert in the airmail field. The current AMB&#160;Chairman is Jason Dacosta (Air Canada).</p><h3 class="iataElement-Title3">Contact</h3><ul><li>Secretary<br><a href="mailto&#58;cargo@iata.org" target="_blank">Andre Majeres<br></a>Manager, Cargo &amp; Mail Operations and Standards<br></li></ul> ​​​​</div></div>
...
<a href="http&#58;//www.upu.int/" target="_blank">Universal Postal Union(UPU)</a><br>
</p><p>
<a href="http&#58;//www.ipc.be/" target="_blank">International Post Corporation (IPC)</a></p></div>
</div>
<div class='hide_element_0946986d-f751-404f-90a2-175f4ac79d43'></div><script type='text/javascript'>CTP.IATA.HideChrome('0946986d-f751-404f-90a2-175f4ac79d43')</script>
<div class='hide_element_f8b55d0d-e3b1-4463-8076-205424c098d1'></div><script type='text/javascript'>CTP.IATA.HideChrome('f8b55d0d-e3b1-4463-8076-205424c098d1')</script>
</div>
</div>
</div>
...
<script type="text/javascript">//<![CDATA[
        ...
        {
            formDigestElement.value = '0x8695352A9E9EDFA65D4A81E1CCD9718A1C42D4AEA5B83D886099323D1DA14DCFA96AC0A31504A1E14D2EA489413E5548A60AB5FFDC9B43F17881DBF1285CF83F,27 Nov 2019 19:23:39 -0000';
...
{
    var initInfo = {editable: false,isEditMode: false,allowWebPartAdder: false,listId: "{67d3e7a9-4552-4e1b-b2aa-c11911aeaabd}",itemId: 148,recycleBinEnabled: true,enableMinorVersioning: true,enableModeration: true,forceCheckout: false,rootFolderUrl: "\u002fwhatwedo\u002fworkgroups\u002fPages",itemPermissions:{High:16,Low:196705}};
