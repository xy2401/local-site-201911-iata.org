...
<meta name="keywords" content='scaptf, standardised computarised aircraft performance, aircraft' />
<meta name="description" content="Basic data has in the past been provided by the airplane manufacturer in various manuals (AFM, Operations Manual, Performance Engineer's Manual) in hard copy form" /><meta name="robots" content="FOLLOW,INDEX" /><meta name="language" content="English" /><title>
		
    
        IATA - Standardised Computerised Aircraft Performance (SCAP) Task Force 
...
<meta property='og:title' content='Standardised Computerised Aircraft Performance (SCAP) Task Force'>
<meta property='og:type' content='website'>
<meta property='og:url' content='https://www.iata.org/whatwedo/workgroups/pages/scaptf.aspx'>
<meta property='og:image' content=''>
<meta property='og:image:secure_url' content=''>
<meta property='og:description' content='Basic data has in the past been provided by the airplane manufacturer in various manuals (AFM, Operations Manual, Performance Engineer&#39;s Manual) in hard copy form'>
<link rel="canonical" href="https://www.iata.org:443/whatwedo/workgroups/Pages/scaptf.aspx" />
...
var guaGmtGlobalRequestUri = "/whatwedo/workgroups/Pages/scaptf.aspx";
var guaGmtGlobalPageTitle = "Standardised Computerised Aircraft Performance (SCAP) Task Force";
...
'page' : {
'requestURI' : "/whatwedo/workgroups/Pages/scaptf.aspx",
'pageType' : "Home",
'device' : "Desktop",
...
<form method="post" action="./scaptf.aspx" id="aspnetForm">
...
<input type="hidden" name="__REQUESTDIGEST" id="__REQUESTDIGEST" value="0xF02F2630501E4921CCCE49990742E3DAB4E5F1B177EDB3E3D72BAD257B56BED13F2B7169C57DEF056ED40C278E8B61C7302E6D45E8FE18FE017E62C1D82D3270,27 Nov 2019 21:42:00 -0000" />
...
var _fV4UI=true;var _spPageContextInfo = {webServerRelativeUrl: "\u002fwhatwedo\u002fworkgroups", webAbsoluteUrl: "https:\u002f\u002fwww.iata.org\u002fwhatwedo\u002fworkgroups", siteAbsoluteUrl: "https:\u002f\u002fwww.iata.org", serverRequestPath: "\u002fwhatwedo\u002fworkgroups\u002fPages\u002fscaptf.aspx", layoutsUrl: "_layouts\u002f15", webTitle: "Workgroups", webTemplate: "10020", tenantAppVersion: "0", isAppWeb: false, Has2019Era: true, webLogoUrl: "\u002f_layouts\u002fimages\u002ftitlegraphic.gif", webLanguage: 1033, currentLanguage: 1033, currentUICultureName: "en-US", currentCultureName: "en-US", clientServerTimeDelta: new Date("2019-11-27T21:42:00.0602938Z") - new Date(), siteClientTag: "367$$15.0.5127.1000", crossDomainPhotosEnabled:false, webUIVersion:15, webPermMasks:{High:16,Low:196705},pageListId:"{67d3e7a9-4552-4e1b-b2aa-c11911aeaabd}",pageItemId:247, pagePersonalizationScope:1, alertsEnabled:true, siteServerRelativeUrl: "\u002f", allowSilverlightPrompt:'True'};document.onreadystatechange=fnRemoveAllStatus; function fnRemoveAllStatus(){removeAllStatus(true)};//]]>
</script>
...
<script language="javascript">
    ...
    function GACode() {
        ...
        _gaq.push(['_trackPageview', '/whatwedo/workgroups/Pages/scaptf.aspx?q=' + document.getElementById("SearchTextBox").value + '&cat=Main_Search']);
        */
        return true;
    }
...
<ul>
<li><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fwww.iata.org%2Fwhatwedo%2Fworkgroups%2Fpages%2Fscaptf.aspx" id="ctl00_PlaceHolderMain_pageTools_linkFB" target="_blank" title="Share this Page"><span class="icon icon-facebook"></span></a></li>
...
<li><a href="//www.linkedin.com/shareArticle?mini=true&url=http%3A%2F%2Fwww.iata.org%2Fwhatwedo%2Fworkgroups%2FPages%2Fscaptf.aspx" id="ctl00_PlaceHolderMain_pageTools_linkLinkedIn" target="_blank"><span class="icon icon-linkedin"></span></a></li>
<li><a href="mailto:?subject=I wanted you to see this site&amp;body=Check out this site http://www.iata.org/whatwedo/workgroups/Pages/scaptf.aspx" id="ctl00_PlaceHolderMain_pageTools_linkMail" title="Share by Email"><span class="icon icon-enveloppeRound"></span></a></li>
</ul>
</div>
</div>
</div>
...
<h1>
Standardised Computerised Aircraft Performance (SCAP) Task Force
</h1>
<menu class="ms-hide">
...
<p>All airlines must provide performance data to enable their crews to operate aircraft safely, economically and in accordance with their applicable certification rules and operating practices. </p>
<p>Basic data has in the past been provided by the airplane manufacturer in various manuals (AFM, Operations Manual, Performance Engineer's Manual) in hard copy form. Progressively this has been supplemented by data provided on magnetic tape/floppy disk to facilitate data entry into programs developed either by the airlines or by airplane manufacturers.</p>
<p>Aspects which require basic performance data applications include takeoff, landing, flight planning, route studies, engine failure procedures, and aircraft performance monitoring, etc.</p>
<p>One particularly complex requirement is the calculation of takeoff performance data. Most airlines use programs supplied by the airplane manufacturers for each airplane type, and interface these programs with their own computer operating environment, airfield database, and data output format requirements.</p>
<p>In order to reduce the development effort for the airlines (interfacing with different airplane manufacturers' programs) and manufacturers (meeting individual airline requirements for customer-specific features) there are clear advantages in standardizing as much as possible the input/output features of these programs, and also data formats.</p>
<p>Having recognised this potential benefit, IATA, ATA and several manufacturers set up a Standardized Computerized Airplane Performance Task Force (SCAP TF).</p>
<p>The task which the SCAP&#160;TF undertook, because of its importance to airlines and manufacturers, was to achieve maximum possible standardization of the performance program interface. The result of that effort are the 6 SCAP Specifications, which define the interface requirements for airplane manufacturer supplied analysis software for implementation in the airline user environment. The 6 SCAP Specifications are &#58; Takeoff, Landing, Climbout, Inflight, Noise and APM (Aircraft Performance Monitoring).The SCAP specifications are applicable to civil, transport category, airplanes. Maintenance and update of the SCAP Specifications has been the responsibility of the SCAP Task Force, meeting annually.</p>
...
<ul>
<li><a href="http&#58;//corp-extranet.iata.org/sites/focwg/default.aspx" target="_blank">Login (IATA Staff)</a> </li>
<li><a href="http&#58;//extranet2.iata.org/sites/focwg/default.aspx" target="_blank">Login (external users)</a> </li>
<li><a href="http&#58;//www2.iata.org/registration/getemailpage.aspx?siteurl=focwg" target="_blank">Registration (external users only)</a> </li></ul></div>
</div>
<div class='hide_element_c70252eb-84fd-49ba-b339-6756d325b0d7'></div><script type='text/javascript'>CTP.IATA.HideChrome('c70252eb-84fd-49ba-b339-6756d325b0d7')</script>
<div class='hide_element_4358bb7a-e9c4-4a94-82c1-9976e41f7e6f'></div><script type='text/javascript'>CTP.IATA.HideChrome('4358bb7a-e9c4-4a94-82c1-9976e41f7e6f')</script>
</div>
</div>
</div>
...
<script type="text/javascript">//<![CDATA[
        ...
        {
            formDigestElement.value = '0xF02F2630501E4921CCCE49990742E3DAB4E5F1B177EDB3E3D72BAD257B56BED13F2B7169C57DEF056ED40C278E8B61C7302E6D45E8FE18FE017E62C1D82D3270,27 Nov 2019 21:42:00 -0000';
...
{
    var initInfo = {editable: false,isEditMode: false,allowWebPartAdder: false,listId: "{67d3e7a9-4552-4e1b-b2aa-c11911aeaabd}",itemId: 247,recycleBinEnabled: true,enableMinorVersioning: true,enableModeration: true,forceCheckout: false,rootFolderUrl: "\u002fwhatwedo\u002fworkgroups\u002fPages",itemPermissions:{High:16,Low:196705}};
