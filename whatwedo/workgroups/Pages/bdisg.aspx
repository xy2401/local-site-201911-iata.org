...
<meta name="keywords" content='ISS Passenger Data Exchange Standards Technical' />
<meta name="description" content="BSP Data Interchange Specifications Group (BDISG) Site is where BDISG meeting details and Data Interchange Specifications handbook (DISH) related information is updated and made available" /><meta name="robots" content="FOLLOW,INDEX" /><meta name="language" content="English" /><title>
		
    
        IATA - BSP Data Interchange Specifications Group (BDISG) 
...
<meta property='og:title' content='BSP Data Interchange Specifications Group (BDISG)'>
<meta property='og:type' content='website'>
<meta property='og:url' content='https://www.iata.org/whatwedo/workgroups/pages/bdisg.aspx'>
<meta property='og:image' content=''>
<meta property='og:image:secure_url' content=''>
<meta property='og:description' content='BSP Data Interchange Specifications Group (BDISG) Site is where BDISG meeting details and Data Interchange Specifications handbook (DISH) related information is updated and made available'>
<link rel="canonical" href="https://www.iata.org:443/whatwedo/workgroups/Pages/bdisg.aspx" />
...
var guaGmtGlobalRequestUri = "/whatwedo/workgroups/Pages/bdisg.aspx";
var guaGmtGlobalPageTitle = "BSP Data Interchange Specifications Group (BDISG)";
...
'page' : {
'requestURI' : "/whatwedo/workgroups/Pages/bdisg.aspx",
'pageType' : "Home",
'device' : "Desktop",
...
<form method="post" action="./bdisg.aspx" id="aspnetForm">
...
<input type="hidden" name="__REQUESTDIGEST" id="__REQUESTDIGEST" value="0x364983C8B28A9999E6043C7FDB44F99EE151B0948997B26B5225951B1B2DA58E05E3B01D04662C8BD134265773B028C374391D6AA5BD8FD366049FBBE5195613,27 Nov 2019 20:32:53 -0000" />
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
...
var _fV4UI=true;var _spPageContextInfo = {webServerRelativeUrl: "\u002fwhatwedo\u002fworkgroups", webAbsoluteUrl: "https:\u002f\u002fwww.iata.org\u002fwhatwedo\u002fworkgroups", siteAbsoluteUrl: "https:\u002f\u002fwww.iata.org", serverRequestPath: "\u002fwhatwedo\u002fworkgroups\u002fPages\u002fbdisg.aspx", layoutsUrl: "_layouts\u002f15", webTitle: "Workgroups", webTemplate: "10020", tenantAppVersion: "0", isAppWeb: false, Has2019Era: true, webLogoUrl: "\u002f_layouts\u002fimages\u002ftitlegraphic.gif", webLanguage: 1033, currentLanguage: 1033, currentUICultureName: "en-US", currentCultureName: "en-US", clientServerTimeDelta: new Date("2019-11-27T20:32:53.4308322Z") - new Date(), siteClientTag: "367$$15.0.5127.1000", crossDomainPhotosEnabled:false, webUIVersion:15, webPermMasks:{High:16,Low:196705},pageListId:"{67d3e7a9-4552-4e1b-b2aa-c11911aeaabd}",pageItemId:157, pagePersonalizationScope:1, alertsEnabled:true, siteServerRelativeUrl: "\u002f", allowSilverlightPrompt:'True'};document.onreadystatechange=fnRemoveAllStatus; function fnRemoveAllStatus(){removeAllStatus(true)};//]]>
</script>
...
<script language="javascript">
    ...
    function GACode() {
        ...
        _gaq.push(['_trackPageview', '/whatwedo/workgroups/Pages/bdisg.aspx?q=' + document.getElementById("SearchTextBox").value + '&cat=Main_Search']);
        */
        return true;
    }
...
<ul>
<li><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fwww.iata.org%2Fwhatwedo%2Fworkgroups%2Fpages%2Fbdisg.aspx" id="ctl00_PlaceHolderMain_pageTools_linkFB" target="_blank" title="Share this Page"><span class="icon icon-facebook"></span></a></li>
...
<li><a href="//www.linkedin.com/shareArticle?mini=true&url=http%3A%2F%2Fwww.iata.org%2Fwhatwedo%2Fworkgroups%2FPages%2Fbdisg.aspx" id="ctl00_PlaceHolderMain_pageTools_linkLinkedIn" target="_blank"><span class="icon icon-linkedin"></span></a></li>
<li><a href="mailto:?subject=I wanted you to see this site&amp;body=Check out this site http://www.iata.org/whatwedo/workgroups/Pages/bdisg.aspx" id="ctl00_PlaceHolderMain_pageTools_linkMail" title="Share by Email"><span class="icon icon-enveloppeRound"></span></a></li>
</ul>
</div>
</div>
</div>
...
<p>​The BSP Data Interchange Specifications Group (BDISG) is established by the Passenger Services Conference (PSC) to develop and maintain technical solutions within the BSP Data Interchange Specifications Handbook (DISH) for the exchange of passenger ticketing and related data between travel agents and airlines for remittance and settlement purposes. </p><p>One of the main objectives of the BDISG is the minimization of local requirements, cost reduction, and decreasing inconsistencies.
&#160;&#160;&#160;</p><div><h3 class="iataElement-Title3">About DISH</h3><div>DISH is the global data interchange standard implemented by all Billing Settlement Plans (BSPs) to ensure consistency and the exchange of the highest possible quality data between BSPs and GDSs, airlines and other business partners.</div><div>&#160;</div><div>The DISH defines the reporting standards to enable GDSs (Global Distribution Systems) to report documents sales made by BSP travel agents to the IATA Data Processing Centers, to enable the sales data to be provided to airlines and credit card acquirers, and aids Remittance and Settlement. Further information on DISH and file downloads of publications are accessible via the
<a href="/publications/Pages/bspdish.aspx" target="_blank">BSP DISH</a>.</div><div>&#160;</div><div>New business requirements and amendments to the DISH are to be submitted to the attention of the BDISG Secretariat (<a href="mailto&#58;standards@iata.org" target="_blank">standards@iata.org</a>) using the
<a href="https://www.iata.org/whatwedo/workgroups/Documents/dish-amend-form.doc" target="_blank">DISH Amendment Form</a> (doc) and <a href="/whatwedo/workgroups/Documents/ai_temp-nontech.docx?Web=1" target="_blank">Agenda Template for non technical matters (doc)</a>. Proposals will be submitted to the next meeting of the BDISG.</div><div>&#160;</div><div>Proposed amendments to DISH discussed and agreed at BDISG are endorsed by the PSC for adoption as an IATA standard. Implementation plans are coordinated by IATA and are driven by the testing procedures and scenarios&#160;outlined in DISH section 4.3.</div> &#160;</div><div><h3 class="iataElement-Title3">What’s New<br></h3><p><span><strong>DISH Revision 23&#160;Update Bulletin 2019/1 (Mandatory)</strong><br></span></p><div><p>The PSC has endorsed various amendments to DISH Revision 23 standards reflected in this new DISH Revision 23 Update Bulletin 2019/1 publication, declared effective 1 April 2019.</p><p><a href="/publications/Documents/dish/DISH%20Revision%2023%20Update%20Bulletin%202019_1.pdf" target="_blank">DISH Revision 23 Update Bulletin 2019/1</a>&#160;(pdf) has been developed to reflect a worldwide data interchange standard to be implemented by all Billing and Settlement Plans (BSPs) ensuring the highest possible quality data is exchanged between BSPs, airlines and strategic partners. The amendments in DISH Revision 23 Update Bulletin 2019/1 are highlighted in the summary of changes in the publication. View the<a href="/publications/Documents/dish/DISH%20Revision%2023%20Update%20Bulletin%202019_1.pdf" target="_blank"></a><a href="/publications/Documents/BSP-DISH-Revision-23.pdf">&#160;DISH revision</a>&#160;(pdf).<br></p><p>DISH 23 Major Amendments.&#160;<br></p><p>In order to produce Revision 23, major amendments include&#58;</p><ul><li>Addition of 3DS and EMV data elements and records for card transactions</li><li>Transparency in Payments (TIP) requirements for alternative payment methods aligned with PSC Resolution 728 on form of payment codes</li><li>New data elements and RET/HOT records to support Complex Taxes Fees and Charges–Additional Coupon Tax Data</li><li>New data elements and RET/HOT records to support GST related information</li><li>CSI file format defined as a Mandatory layout for card transactions</li><li>Complete revision of Testing/Certification Procedures and RET/HOT Data Quality Assurance in DISH Chapter 4</li><li>Exempted taxes reflected within the TMFA &amp; TMFT data elements</li><li>New Diners/Discover and JCB specifications to the FPTI data element</li><li>Addition of other new data element indicators related to Change of Gauge, Commission Control Adjustment, Arrival Date, Arrival Time, Departure Terminal and Arrival Terminal</li><li>Mandatory/Conditional Status modifications to records and fields in alignment to PSC &amp; Ticketing Resolutions</li><li>Modification of CSI and CSP data elements status anomalies</li></ul><p><strong>DISH 23 replaces all previous Revisions and is presented as a mandatory Revision. </strong>Testing procedures and scenarios in Chapter 4 are to be followed.&#160;</p></div></div><h3 class="iataElement-Title3">Composition and Meetings</h3><div>Meetings of the BDISG are open to all IATA member airlines (particularly involved in revenue accounting) and to BSP partners within the IATA Strategic Partnership Program providing RETs (agent reporting data) to BSPs.</div><div> &#160;</div><div>BDISG participants have the opportunity to model the standards based on business requirements. The BDISG also liaises with other industry committees directed under the Passenger Services and Passenger Agency Conferences to progress DISH developments.</div><div> &#160;</div><div>There is no restriction on the number of participants and they meet once a year. </div><div> &#160;</div><h3 class="iataElement-Title3">Publication and Resources</h3><ul><li><a href="/publications/Documents/dish/DISH-Revision-23-Correction%20Notice-21May2019.pdf" target="_blank">BSP DISH Revision 23 Correction Notice - May 2019 </a>(pdf)<br></li><li><a href="/publications/Documents/dish/DISH%20Revision%2023%20Update%20Bulletin%202019_1.pdf" target="_blank">BSP DISH Revision 23</a> (pdf)<br></li></ul><ul><li><span aria-hidden="true"></span><a href="/publications/Documents/dish-revision-23-correction-notice-jul2018.pdf" target="_blank">BSP DISH Revision 23 Correction Notice - July 2018 </a>(pdf)</li><li><a href="/publications/Documents/dish/bsp-dish-revision-23-project.zip">BSP DISH Revision 23 Project</a> (zip)</li></ul><ul><li><a href="/whatwedo/workgroups/Documents/DISH-Revision-22-Update-Bulletin-2018-1.pdf" target="_blank">BSP DISH Revision 22 Update Bulletin 2018/1</a>&#160;(pdf)</li></ul><ul><li><a href="/whatwedo/workgroups/Documents/bsp-dish-rev22-2016.pdf" target="_blank">BSP DISH Revision 22 Publication and Update Bulletin 2016/1</a> (pdf) </li></ul><ul><li>
<a href="https://www.iata.org/whatwedo/workgroups/Documents/BDIGTOR2019.pdf" target="_blank">BDISG - Terms of Reference</a> (pdf)</li></ul><div>DISH publications are also located on the following <a href="/dish">public BSP DISH site</a>.</div><div>&#160;</div><div><h3 class="iataElement-Title3">Private Site</h3><div>The BDISG site (links below) is where BDISG meeting details and DISH related information is updated and made available.</div><div>&#160;</div></div><div>The Private portion of the website is reserved for Member Airlines and qualified Strategic Partnership Members registered within the Passenger and Airport Services area and involved in IATA Passenger Settlement Systems in providing agent reporting data (RET) to a Billing and Settlement Plan (BSP).&#160; </div><div>&#160;</div><div>Companies and organisations interested in BSP Data Interchange Standards are invited to join our IATA Strategic Partnerships.</div><div>&#160;</div><div><div>
<a href="http&#58;//corp-extranet.iata.org/sites/bdisg/default.aspx" target="_blank">
<span>Login (IATA Staff)</span></a></div><div>
<a href="http&#58;//extranet2.iata.org/sites/bdisg/default.aspx" target="_blank">
<span>Login (external users)</span></a></div><div>
<a href="http&#58;//www2.iata.org/registration/getemailpage.aspx?siteurl=bdisg" target="_blank">
<span>Registration (external users only)</span></a></div></div><div><div>&#160;</div><h3 class="iataElement-Title3">Need more information?</h3><div>Please contact us at&#58;
&#160;<a href="mailto&#58;standards@iata.org" target="_blank">standards@iata.org</a></div></div>
...
<div class="newstg">
<div><a href="/whatwedo/workgroups/Pages/calendar.aspx" target="_blank">IATA Calendar of Meetings</a></div></div>
</div>
</div>
<div class='hide_element_8af539bc-28ae-485a-8691-bf474d74b14b'></div><script type='text/javascript'>CTP.IATA.HideChrome('8af539bc-28ae-485a-8691-bf474d74b14b')</script>
<div class='hide_element_beb3015c-56ad-454a-9f57-a8290daf7d16'></div><script type='text/javascript'>CTP.IATA.HideChrome('beb3015c-56ad-454a-9f57-a8290daf7d16')</script>
</div>
</div>
</div>
...
<script type="text/javascript">//<![CDATA[
        ...
        {
            formDigestElement.value = '0x364983C8B28A9999E6043C7FDB44F99EE151B0948997B26B5225951B1B2DA58E05E3B01D04662C8BD134265773B028C374391D6AA5BD8FD366049FBBE5195613,27 Nov 2019 20:32:53 -0000';
...
{
    var initInfo = {editable: false,isEditMode: false,allowWebPartAdder: false,listId: "{67d3e7a9-4552-4e1b-b2aa-c11911aeaabd}",itemId: 157,recycleBinEnabled: true,enableMinorVersioning: true,enableModeration: true,forceCheckout: false,rootFolderUrl: "\u002fwhatwedo\u002fworkgroups\u002fPages",itemPermissions:{High:16,Low:196705}};
