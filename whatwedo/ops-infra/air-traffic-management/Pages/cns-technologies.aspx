...
<h3 class="iataElement-Title3">​User Requirements for Air Traffic Services (URATs)</h3><p>The <a href="https://www.iata.org/whatwedo/ops-infra/air-traffic-management/Documents/Requirements-URATS-CNS-technology_Edition%203_2017.pdf" target="_blank">IATA User Requirements for Air Traffic Services (URATs)</a> is designed to act as a reference point for airlines and ANSPs when determining airline infrastructure requirements and capabilities for air navigation services. The document aims to complement the ICAO Global Air Navigation Plan (GANP) whilst succinctly stating IATA’s positions on the various communication, navigation and surveillance technologies.</p><p><strong>Any technology&#160;will need to fulfil the following&#160;requirements prior to actual funding or implementation&#58;</strong> </p><ul><li>
...
Explore more
</div><ul class='iata-crossLink-List'><li class='iata-crossLink-header'>Training</li><li class='iata-crossLink-entry' data-guid='d48116f6-0fdd-4e27-b19a-57a10b0a98d9'><div class='iata-crossLink-Label'><a href='/training/subject-areas/pages/air-navigation-courses.aspx'>Air Navigation</a><span class='iata-crossLink-highliteTags'><span class='iata-crossLink-tags'></span></span></div></li><li class='iata-crossLink-header'>Services</li><li class='iata-crossLink-entry' data-guid='ccc30ed7-bba0-417b-949f-1305ecac5cd3'><div class='iata-crossLink-Label'><a href='/services/safety-flight-operations/pages/skyfusion.aspx'>Data Exchange for Air Traffic Management</a><span class='iata-crossLink-highliteTags'><span class='iata-crossLink-tags'>Business Intelligence, Safety Solutions</span></span></div></li></ul></div>
</div>
</div>
</div>
