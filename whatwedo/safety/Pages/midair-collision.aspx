...
<a href="/whatwedo/safety/Documents/IATA_guidance_Assessment_of_pilot_compliance_to_TCAS.pdf" target="_blank">Performance assessment of pilot compliance to Traffic Alert and Collision Avoidance System (TCAS) using Flight Data Monitoring (FDM)</a>&#160;(pdf). This document highlights that the most important single factor affecting the performance of TCAS is the response of pilots to RAs.&#160; It also states several <a href="/whatwedo/safety/Documents/Recommendations-from-IATA-guidance-on-TCAS.pdf" target="_blank">recommendations to enable TCAS to deliver its safety objective of preventing mid-air collision</a> (PDF).<br><span class="iataStyle-Normal"><br>This guide, which is based on the
