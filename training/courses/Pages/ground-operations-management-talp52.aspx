...
<meta name="keywords" content='Ground, Handling,  Occupational, Health,    Risk, emergency,  accidents, ramp, damages,  handling, aircraft, services,  Hand, Signals,  Support, Equipment, danger, Health, Traffic, Rules,Incident, Reporting, Fire, First, Aid, Prevention, protection, aviation, training, course' />
<meta name="description" content="<p>
	...
	Ground Operations Management  - IATA Training Course
...
<link rel="canonical" href="https://www.iata.org:443/training/courses/Pages/ground-operations-management-talp52.aspx" />
...
var guaGmtGlobalRequestUri = "/training/courses/Pages/ground-operations-management-talp52.aspx";
var guaGmtGlobalPageTitle = "TALP-52";
...
'page' : {
'requestURI' : "/training/courses/Pages/ground-operations-management-talp52.aspx",
'pageType' : "Home",
'device' : "Desktop",
...
<form method="post" action="./ground-operations-management-talp52.aspx" id="aspnetForm">
...
<input type="hidden" name="__REQUESTDIGEST" id="__REQUESTDIGEST" value="0x039451B513CFC57B86610A46C350E460A78B3C1AD2F286747AC068AADF11B7C09E1BDEAF0864E02A321E345AB76692CF256787908E3CC02CFF98744EE5ABE0BA,27 Nov 2019 18:14:14 -0000" />
...
var _fV4UI=true;var _spPageContextInfo = {webServerRelativeUrl: "\u002ftraining\u002fcourses", webAbsoluteUrl: "https:\u002f\u002fwww.iata.org\u002ftraining\u002fcourses", siteAbsoluteUrl: "https:\u002f\u002fwww.iata.org", serverRequestPath: "\u002ftraining\u002fcourses\u002fPages\u002fground-operations-management-talp52.aspx", layoutsUrl: "_layouts\u002f15", webTitle: "Search Courses", webTemplate: "10020", tenantAppVersion: "0", isAppWeb: false, Has2019Era: true, webLogoUrl: "\u002f_layouts\u002fimages\u002ftitlegraphic.gif", webLanguage: 1033, currentLanguage: 1033, currentUICultureName: "en-US", currentCultureName: "en-US", clientServerTimeDelta: new Date("2019-11-27T18:14:14.1159497Z") - new Date(), siteClientTag: "367$$15.0.5127.1000", crossDomainPhotosEnabled:false, webUIVersion:15, webPermMasks:{High:16,Low:196705},pageListId:"{0d58168f-feef-45ff-bc51-7b9336e39b71}",pageItemId:1077, pagePersonalizationScope:1, alertsEnabled:true, siteServerRelativeUrl: "\u002f", allowSilverlightPrompt:'True'};document.onreadystatechange=fnRemoveAllStatus; function fnRemoveAllStatus(){removeAllStatus(true)};//]]>
</script>
...
<script language="javascript">
    ...
    function GACode() {
        ...
        _gaq.push(['_trackPageview', '/training/courses/Pages/ground-operations-management-talp52.aspx?q=' + document.getElementById("SearchTextBox").value + '&cat=Main_Search']);
        */
        return true;
    }
...
<ul>
<li><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2Fpages%2Fground-operations-management-talp52.aspx" id="ctl00_PlaceHolderMain_pageTools_linkFB" target="_blank" title="Share this Page"><span class="icon icon-facebook"></span></a></li>
...
<li><a href="//www.linkedin.com/shareArticle?mini=true&url=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2FPages%2Fground-operations-management-talp52.aspx" id="ctl00_PlaceHolderMain_pageTools_linkLinkedIn" target="_blank"><span class="icon icon-linkedin"></span></a></li>
<li><a href="mailto:?subject=I wanted you to see this site&amp;body=Check out this site http://www.iata.org/training/courses/Pages/ground-operations-management-talp52.aspx" id="ctl00_PlaceHolderMain_pageTools_linkMail" title="Share by Email"><span class="icon icon-enveloppeRound"></span></a></li>
</ul>
</div>
</div>
</div>
...
<p>
Control and supervise an airline station in a self-handled or outsourced environment.</p>
</span></span>
...
<li> This course requires approximately 60-70 hours of study to be completed in 12 months from the purchase date (enrollment validity). After the enrollment validity expires, the users will not have access to the course content and will not be able to take the exam.</li>
<li>Student performance will be based on an examination. Please refer to the <a href="#ExamInfo">Exam Information</a> below for more details.</li></ul><h3>Prerequisites</h3>Participants are recommended to have at least 2 years of professional experience across ground handling functions
</span></span>
...
<li>Control and supervise an airline station in a self-handled or outsourced environment</li><li>Use Ground Handling and Service Level Agreements (SLAs) to suit your station's handling needs, reduce costs and provide quality service</li><li>Prevent fraud by being knowledgeable about the current methods that fraudsters use to dilute airline revenues</li><li>Implement a Safety and Security Station Management System according to industry standards and recommended practices</li><li>Motivate staff and effectively monitor their performance</li><li>Use and work with the latest edition of the IATA Airport Handling Manual (AHM) which is included in the course price.</li></ul>
</span></span>
...
<li>Airlines, ground handling and other service providers</li><li>Airport authorities</li><li>Ground operations professionals at a supervisory level</li></ul>
</span></span>
...
<h4>Further training</h4><p>Graduates of this course can apply for the <a href="http&#58;//www.iata.org/training/courses/Pages/tcgp58.aspx" target="_blank">Harvard ManageMentor© (HMM)</a> distance learning program at a special graduate price.</p><p><strong>iPad package<br></strong>Select any 4 <a href="http&#58;//www.iata.org/training/courses/Pages/aviation-studies-iPad.aspx" title="">Aviation Courses</a> in e-textbook format and receive them with a free iPad.</p>
</span></span>
...
<li><a href="https://www.iata.org/training/subject-areas/Pages/ground-operations-courses.aspx">Ground operations</a></li><li><a href="https://www.iata.org/training/subject-areas/Pages/airline-operations-quality.aspx">Quality, audit and operations</a></li>
</ul>
</td>
</tr>
</table>
...
<td>$760 (eBook) / 785 (printed format)</td>
</tr>
<tr>
<td><strong>Regular Fee (USD)</strong></td>
<td>$910 (eBook) / 935 (printed format)</td>
</tr>
<tr>
<td><strong>Note: </strong><p>Learn how to supervise an airline station in a self-handled or out-sourced environment. Get the latest trends in passenger and baggage handling. This course comes with a complimentary copy of the IATA Airport Handling Manual (AHM).<span></span></p></td>
...
<td><strong><span id="ctl00_PlaceHolderMain_TabContainer1_TabPanel3_DistanceLearningDetails_EnrolLink"><INPUT type='button' value='Buy ebook' class='primaryBtn' onclick="window.open('http://training.iata.org/purchases/new?sitting_id=&product_id=629', '_blank')"> / <INPUT type='button' value='Buy printed' class='primaryBtn' onclick="window.open('http://training.iata.org/purchases/new?sitting_id=&product_id=630', '_blank')"></span><strong></td>
</tr>
</tbody>
</thead>
</table>
...
<div class='hide_element_5e440bde-a523-4794-943a-bd4f273df248'></div><script type='text/javascript'>CTP.IATA.HideChrome('5e440bde-a523-4794-943a-bd4f273df248')</script>
<div class='hide_element_4e9abdab-80ec-467c-b1d8-2544de070e78'></div><script type='text/javascript'>CTP.IATA.HideChrome('4e9abdab-80ec-467c-b1d8-2544de070e78')</script>
</div>
</div>
</div>
...
<script type="text/javascript">//<![CDATA[
        ...
        {
            formDigestElement.value = '0x039451B513CFC57B86610A46C350E460A78B3C1AD2F286747AC068AADF11B7C09E1BDEAF0864E02A321E345AB76692CF256787908E3CC02CFF98744EE5ABE0BA,27 Nov 2019 18:14:14 -0000';
...
{
    var initInfo = {editable: false,isEditMode: false,allowWebPartAdder: false,listId: "{0d58168f-feef-45ff-bc51-7b9336e39b71}",itemId: 1077,recycleBinEnabled: true,enableMinorVersioning: true,enableModeration: false,forceCheckout: false,rootFolderUrl: "\u002ftraining\u002fcourses\u002fPages",itemPermissions:{High:16,Low:196673}};
