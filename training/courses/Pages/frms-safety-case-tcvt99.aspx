...
<meta name="keywords" content='fatigue risk management systems, frms, fatigue, safety, safety performance, targets, performance, regulators, training, course, aviation, safety assurance, regulatory processes, safety case' />
<meta name="description" content="<p>Benefit from the latest information from world leading safety regulators, operators and scientific organizations.</p>" /><meta name="robots" content="FOLLOW,INDEX" /><title>
	
	Fatigue Risk Management Systems (FRMS) and Safety Case Training for Regulators (Classroom, 3 days)  - IATA Training Course
...
<link rel="canonical" href="https://www.iata.org:443/training/courses/Pages/frms-safety-case-tcvt99.aspx" />
...
var guaGmtGlobalRequestUri = "/training/courses/Pages/frms-safety-case-tcvt99.aspx";
var guaGmtGlobalPageTitle = "TCVT-99";
...
'page' : {
'requestURI' : "/training/courses/Pages/frms-safety-case-tcvt99.aspx",
'pageType' : "Home",
'device' : "Desktop",
...
<form method="post" action="./frms-safety-case-tcvt99.aspx" id="aspnetForm">
...
<input type="hidden" name="__REQUESTDIGEST" id="__REQUESTDIGEST" value="0x7FAE6997773892583492A1668544EC322E7724275E25CDFFAC19F26FB4DA0D58C40AE20663A481026570171D1E3E38736E4D4B2FD15ADBA533507A957ADD1887,27 Nov 2019 18:08:26 -0000" />
...
var _fV4UI=true;var _spPageContextInfo = {webServerRelativeUrl: "\u002ftraining\u002fcourses", webAbsoluteUrl: "https:\u002f\u002fwww.iata.org\u002ftraining\u002fcourses", siteAbsoluteUrl: "https:\u002f\u002fwww.iata.org", serverRequestPath: "\u002ftraining\u002fcourses\u002fPages\u002ffrms-safety-case-tcvt99.aspx", layoutsUrl: "_layouts\u002f15", webTitle: "Search Courses", webTemplate: "10020", tenantAppVersion: "0", isAppWeb: false, Has2019Era: true, webLogoUrl: "\u002f_layouts\u002fimages\u002ftitlegraphic.gif", webLanguage: 1033, currentLanguage: 1033, currentUICultureName: "en-US", currentCultureName: "en-US", clientServerTimeDelta: new Date("2019-11-27T18:08:26.5632322Z") - new Date(), siteClientTag: "367$$15.0.5127.1000", crossDomainPhotosEnabled:false, webUIVersion:15, webPermMasks:{High:16,Low:196705},pageListId:"{0d58168f-feef-45ff-bc51-7b9336e39b71}",pageItemId:1478980, pagePersonalizationScope:1, alertsEnabled:true, siteServerRelativeUrl: "\u002f", allowSilverlightPrompt:'True'};document.onreadystatechange=fnRemoveAllStatus; function fnRemoveAllStatus(){removeAllStatus(true)};//]]>
</script>
...
<script language="javascript">
    ...
    function GACode() {
        ...
        _gaq.push(['_trackPageview', '/training/courses/Pages/frms-safety-case-tcvt99.aspx?q=' + document.getElementById("SearchTextBox").value + '&cat=Main_Search']);
        */
        return true;
    }
...
<ul>
<li><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2Fpages%2Ffrms-safety-case-tcvt99.aspx" id="ctl00_PlaceHolderMain_pageTools_linkFB" target="_blank" title="Share this Page"><span class="icon icon-facebook"></span></a></li>
...
<li><a href="//www.linkedin.com/shareArticle?mini=true&url=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2FPages%2Ffrms-safety-case-tcvt99.aspx" id="ctl00_PlaceHolderMain_pageTools_linkLinkedIn" target="_blank"><span class="icon icon-linkedin"></span></a></li>
<li><a href="mailto:?subject=I wanted you to see this site&amp;body=Check out this site http://www.iata.org/training/courses/Pages/frms-safety-case-tcvt99.aspx" id="ctl00_PlaceHolderMain_pageTools_linkMail" title="Share by Email"><span class="icon icon-enveloppeRound"></span></a></li>
</ul>
</div>
</div>
</div>
...
Fatigue Risk Management Systems (FRMS) and Safety Case Training for Regulators (Classroom, 3 days)
</h1><br />
...
<li>Participants should have prior knowledge of the different ICAO-approved approaches for fatigue risk management and your State’s proposed regulations and guidance material. This is self-assessed.</li>
...
<li>Analyze the latest information from world leading safety regulators, operators and scientific organizations to assist in the building of safety cases</li><li>Evaluate Biomathematical Fatigue Models with a focus on their uses, abuses and limitations</li><li>Choose FRMS Safety Performance Indicators (SPI), targets, and monitoring processes</li><li>Contribute to the development of Guidance Material for operators overseen by your State</li><li>Help formulate robust regulatory oversight and audit practices</li></ul>
</span></span>
...
<ul><li>Update on fatigue science and its applications in FRMS implementation.</li><li>Introduction to the development and use of FRMS safety performance indicators, targets, and monitoring throughout an FRMS.</li><li>Implications for regulators and service providers of the different ICAO-approved fatigue risk management approaches, including when and how the common elements between an FRMS and an SMS can be integrated.</li><li>Detailed coverage of FRM processes and FRMS safety assurance processes in principle and in practice.</li><li>A review of regulatory processes and issues for FRMS implementation.</li><li>Safety cases, both for supporting a variance from the prescriptive approach and for use in an FRMS.</li><li>How an operator builds and validates a safety case, and the process of regulatory review of safety case submissions.<span></span></li></ul><p>
<a href="/training/courses/Pages/download-file.aspx?documentName=/training-tcvt99-frms-safety-regulators.pdf&amp;documentID=1123" target="_blank"><img src="/training/Icons/dwnl_outline.png" alt="Download the course outline" /></a>
</p><p><strong> Activities</strong></p><ul>
<li>Exercises and Case Studies
</li></ul>
</span></span>
...
<p>This course is recommended for CAA and Aviation Regulator staff in particular&#58;</p><ul><li>FRMS Project staff, management leads responsible for pilot projects</li><li>Flight Operations Inspectors especially those responsible for building FRMS capacity in a State,</li><li>Standards and subject matter experts on flight and duty times and FRMS</li></ul>
</span></span>
...
<div class='hide_element_3b9055f8-7a58-4eb1-b5d2-3be619487649'></div><script type='text/javascript'>CTP.IATA.HideChrome('3b9055f8-7a58-4eb1-b5d2-3be619487649')</script>
<div class='hide_element_f91836bf-8747-4d27-bc42-da64d6e44c4b'></div><script type='text/javascript'>CTP.IATA.HideChrome('f91836bf-8747-4d27-bc42-da64d6e44c4b')</script>
</div>
</div>
</div>
...
<script type="text/javascript">//<![CDATA[
        ...
        {
            formDigestElement.value = '0x7A886DB9F9574BC515042832C2AFE7BE956CC47D7D80B10B414A6487D9089C9DC0A9CBA2D5DD5DF20A7446A8FBE0036D077590530B2D6EECBBD133B375840410,27 Nov 2019 18:08:27 -0000';
...
{
    var initInfo = {editable: false,isEditMode: false,allowWebPartAdder: false,listId: "{0d58168f-feef-45ff-bc51-7b9336e39b71}",itemId: 1478980,recycleBinEnabled: true,enableMinorVersioning: true,enableModeration: false,forceCheckout: false,rootFolderUrl: "\u002ftraining\u002fcourses\u002fPages",itemPermissions:{High:16,Low:196673}};
