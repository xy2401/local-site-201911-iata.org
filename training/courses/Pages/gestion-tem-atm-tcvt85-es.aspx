...
<meta name="keywords" content='atm, incidentes, accidentes, aviación, investigación, Sistema de Gestión de la Seguridad Operacional, SMS, Gestión del tráfico aéreo, Gestión de amenazas y errores, Gestión de recursos de equipo, TRM, Gestión de recursos de la tripulación, CRM, Estudio de la seguridad de las operaciones normales, NOSS, OACI' />
<meta name="description" content="<p>Los conceptos de Gestión de recursos de equipo (TRM) y, específicamente, de la Gestión de amenaza de errores (TEM), de la seguridad operacional en el marco de la Gestión del tránsito aéreo (ATM).</p>" /><meta name="robots" content="FOLLOW,INDEX" /><meta name="language" content="Spanish" /><title>
	
	Gestión de amenazas y errores (TEM) en la Gestión del tráfico aéreo (ATM)  - IATA Training Course
...
<link rel="canonical" href="https://www.iata.org:443/training/courses/Pages/gestion-tem-atm-tcvt85-es.aspx" />
...
var guaGmtGlobalRequestUri = "/training/courses/Pages/gestion-tem-atm-tcvt85-es.aspx";
var guaGmtGlobalPageTitle = "TCVT-85";
...
'page' : {
'requestURI' : "/training/courses/Pages/gestion-tem-atm-tcvt85-es.aspx",
'pageType' : "Home",
'device' : "Desktop",
...
<form method="post" action="./gestion-tem-atm-tcvt85-es.aspx" id="aspnetForm">
...
<input type="hidden" name="__REQUESTDIGEST" id="__REQUESTDIGEST" value="0x1DBC6F521D665147CE8D0B03ABF60927FC35320E39A471DC4AD6E90CAE5ED81B62B1B422E3EE93A3A7AEF535E180BD38050672F135CB2D7B094521FCA297C116,27 Nov 2019 18:08:34 -0000" />
...
var _fV4UI=true;var _spPageContextInfo = {webServerRelativeUrl: "\u002ftraining\u002fcourses", webAbsoluteUrl: "https:\u002f\u002fwww.iata.org\u002ftraining\u002fcourses", siteAbsoluteUrl: "https:\u002f\u002fwww.iata.org", serverRequestPath: "\u002ftraining\u002fcourses\u002fPages\u002fgestion-tem-atm-tcvt85-es.aspx", layoutsUrl: "_layouts\u002f15", webTitle: "Search Courses", webTemplate: "10020", tenantAppVersion: "0", isAppWeb: false, Has2019Era: true, webLogoUrl: "\u002f_layouts\u002fimages\u002ftitlegraphic.gif", webLanguage: 1033, currentLanguage: 1033, currentUICultureName: "en-US", currentCultureName: "en-US", clientServerTimeDelta: new Date("2019-11-27T18:08:34.1136811Z") - new Date(), siteClientTag: "367$$15.0.5127.1000", crossDomainPhotosEnabled:false, webUIVersion:15, webPermMasks:{High:16,Low:196705},pageListId:"{0d58168f-feef-45ff-bc51-7b9336e39b71}",pageItemId:1145012, pagePersonalizationScope:1, alertsEnabled:true, siteServerRelativeUrl: "\u002f", allowSilverlightPrompt:'True'};document.onreadystatechange=fnRemoveAllStatus; function fnRemoveAllStatus(){removeAllStatus(true)};//]]>
</script>
...
<script language="javascript">
    ...
    function GACode() {
        ...
        _gaq.push(['_trackPageview', '/training/courses/Pages/gestion-tem-atm-tcvt85-es.aspx?q=' + document.getElementById("SearchTextBox").value + '&cat=Main_Search']);
        */
        return true;
    }
...
<ul>
<li><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2Fpages%2Fgestion-tem-atm-tcvt85-es.aspx" id="ctl00_PlaceHolderMain_pageTools_linkFB" target="_blank" title="Share this Page"><span class="icon icon-facebook"></span></a></li>
...
<li><a href="//www.linkedin.com/shareArticle?mini=true&url=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2FPages%2Fgestion-tem-atm-tcvt85-es.aspx" id="ctl00_PlaceHolderMain_pageTools_linkLinkedIn" target="_blank"><span class="icon icon-linkedin"></span></a></li>
<li><a href="mailto:?subject=I wanted you to see this site&amp;body=Check out this site http://www.iata.org/training/courses/Pages/gestion-tem-atm-tcvt85-es.aspx" id="ctl00_PlaceHolderMain_pageTools_linkMail" title="Share by Email"><span class="icon icon-enveloppeRound"></span></a></li>
</ul>
</div>
</div>
</div>
...
Gestión de amenazas y errores (TEM) en la Gestión del tráfico aéreo (ATM)
</h1><br />
<span id="ctl00_PlaceHolderMain_cpMainContentTitle_ctl00_otherLanguageCourses_lblOtherCoureses"><a href='/training/courses/Pages/incident-threat-prevention-tcvt85.aspx' target='_blank'>This course is also available in English.</a><br /><br /></span>
...
<p>Aprenda a prevenir incidentes y accidentes utilizando un enfoque estructurado y documentado de la gestión de la seguridad operacional en el marco de la Gestión del tránsito aéreo. Se le enseñará a aplicar los conceptos de Gestión de recursos de equipo (TRM) y, específicamente, de la Gestión de amenaza de errores (TEM).</p><p> Este curso está disponible en <a href="/training/delivery/Pages/classroom-training-centers.aspx" target="_blank"> Centros de Formación IATA </a>, <a href="/training/Pages/regional_training_centres.aspx" target="_blank"> Ubicaciones de Formación Regional de Socios</a>, y por encargo como <a href="/training/delivery/Pages/in-company.aspx" target="_blank"> formación en empresa</a> </p>
...
<h4>Objetivos</h4><p>Al completar este curso tendrá los recursos para&#58;</p><ul><li>Relacionar los modelos de causas de accidentes con la ATM</li><li>Aplicar los métodos de investigación y prevención de accidentes</li><li>Analizar el Sistema de Gestión de la Seguridad Operacional (SMS) de la OACI en la Gestión del tráfico aéreo </li><li>Usar los conceptos de la TRM en las operaciones diarias </li><li>Aplicar el marco de trabajo de la Gestión de amenazas y errores (TEM) a la ATM </li><li>Analizar las contramedidas de la TEM y cómo aplicarlas </li><li>Familiarizarse con los modos de evitar errores</li></ul>
</span></span>
...
<h4> Temas principales</h4><ul><li>Modelos de prevención de accidentes e incidentes en el ámbito de la aviación </li><li>Requerimientos de la investigación de accidentes e incidentes, técnicas y prácticas de trabajo, según los estándares del Anexo 13 de la OACI</li><li>La OACI y la seguridad operacional en la ATM </li><li>Gestión de riesgos de la seguridad operacional </li><li>Documentación de los requerimientos de seguridad operacional </li><li>Garantía de seguridad operacional </li><li>De la Gestión de recursos de la tripulación (CRM) a la Gestión de recursos de equipo (TRM) </li><li>Conceptos de la CRM y Gestión de la seguridad operacional </li><li>Gestión de amenazas y errores (TEM) </li><li>Estudio de la seguridad de las operaciones normales (NOSS) de la OACI </li><li>Capacitación del equipo y trabajo en equipo </li><li>Contramedidas y ejecución en la TEM </li><li>Modos de evitar errores en el control del tráfico aéreo </li></ul><p>
<a href="/training/courses/Pages/download-file.aspx?documentName=/training-tcvt85es-gestion-amenazas-errores.pdf&amp;documentID=951" target="_blank"><img src="/training/Icons/dwnl_temario.png" alt="Descargue el temario del curso" /></a>
</p><p><strong>Actividades&#58;</strong></p><ul><li>Ejercicios </li><li>Estudios de caso</li></ul>
</span></span>
...
<h4>Audiencia</h4><p>Este curso está recomendado para&#58;</p><ul><li>Controladores de tráfico aéreo </li><li>Personal operativo y directores de empresas que proveen servicios de gestión del tráfico aéreo</li></ul>
</span></span>
...
<div class='hide_element_3cd089b9-bb9e-4cb2-9758-a98c8be51862'></div><script type='text/javascript'>CTP.IATA.HideChrome('3cd089b9-bb9e-4cb2-9758-a98c8be51862')</script>
<div class='hide_element_a25c9e75-36bd-4181-add3-7508c3aee2ed'></div><script type='text/javascript'>CTP.IATA.HideChrome('a25c9e75-36bd-4181-add3-7508c3aee2ed')</script>
</div>
</div>
</div>
...
<script type="text/javascript">//<![CDATA[
        ...
        {
            formDigestElement.value = '0x4AC40A789A4970BFA70D56CD1020DA5F5FB0CCF674EAFB9848B2F08DADEFFF5BE8EDA272FB4DFC38B5DC9C09613182BC843953619338D3DECAB0B7CFB81D5142,27 Nov 2019 18:08:35 -0000';
...
{
    var initInfo = {editable: false,isEditMode: false,allowWebPartAdder: false,listId: "{0d58168f-feef-45ff-bc51-7b9336e39b71}",itemId: 1145012,recycleBinEnabled: true,enableMinorVersioning: true,enableModeration: false,forceCheckout: false,rootFolderUrl: "\u002ftraining\u002fcourses\u002fPages",itemPermissions:{High:16,Low:196673}};
