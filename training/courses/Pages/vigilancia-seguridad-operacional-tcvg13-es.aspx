...
<meta name="keywords" content='seguridad operacional, sistema de vigilancia, vigilancia, seguridad, USOAP, gestión, implementación obligatoria, operacional' />
<meta name="description" content="<p>Entender los principales aspectos de la vigilancia de la seguridad operacional en el ámbito de la aviación civil</p>" /><meta name="robots" content="FOLLOW,INDEX" /><meta name="language" content="Spanish" /><title>
	
	Gestión de vigilancia de la seguridad operacional (presencial, 5 días)  - IATA Training Course
...
<link rel="canonical" href="https://www.iata.org:443/training/courses/Pages/vigilancia-seguridad-operacional-tcvg13-es.aspx" />
...
var guaGmtGlobalRequestUri = "/training/courses/Pages/vigilancia-seguridad-operacional-tcvg13-es.aspx";
...
'page' : {
'requestURI' : "/training/courses/Pages/vigilancia-seguridad-operacional-tcvg13-es.aspx",
'pageType' : "Home",
'device' : "Desktop",
...
<form method="post" action="./vigilancia-seguridad-operacional-tcvg13-es.aspx" id="aspnetForm">
...
<input type="hidden" name="__REQUESTDIGEST" id="__REQUESTDIGEST" value="0x4709FC4F569FC85C396208C138312F71733969BA1F40FC893EFA30EBDF3119D410E775AECF3C6237DC6A3B9A568B383608F3DDB67581135ECCBE3F2660444B80,27 Nov 2019 18:11:29 -0000" />
...
var _fV4UI=true;var _spPageContextInfo = {webServerRelativeUrl: "\u002ftraining\u002fcourses", webAbsoluteUrl: "https:\u002f\u002fwww.iata.org\u002ftraining\u002fcourses", siteAbsoluteUrl: "https:\u002f\u002fwww.iata.org", serverRequestPath: "\u002ftraining\u002fcourses\u002fPages\u002fvigilancia-seguridad-operacional-tcvg13-es.aspx", layoutsUrl: "_layouts\u002f15", webTitle: "Search Courses", webTemplate: "10020", tenantAppVersion: "0", isAppWeb: false, Has2019Era: true, webLogoUrl: "\u002f_layouts\u002fimages\u002ftitlegraphic.gif", webLanguage: 1033, currentLanguage: 1033, currentUICultureName: "en-US", currentCultureName: "en-US", clientServerTimeDelta: new Date("2019-11-27T18:11:29.5202193Z") - new Date(), siteClientTag: "367$$15.0.5127.1000", crossDomainPhotosEnabled:false, webUIVersion:15, webPermMasks:{High:16,Low:196705},pageListId:"{0d58168f-feef-45ff-bc51-7b9336e39b71}",pageItemId:1126420, pagePersonalizationScope:1, alertsEnabled:true, siteServerRelativeUrl: "\u002f", allowSilverlightPrompt:'True'};document.onreadystatechange=fnRemoveAllStatus; function fnRemoveAllStatus(){removeAllStatus(true)};//]]>
</script>
...
<script language="javascript">
    ...
    function GACode() {
        ...
        _gaq.push(['_trackPageview', '/training/courses/Pages/vigilancia-seguridad-operacional-tcvg13-es.aspx?q=' + document.getElementById("SearchTextBox").value + '&cat=Main_Search']);
        */
        return true;
    }
...
<ul>
<li><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2Fpages%2Fvigilancia-seguridad-operacional-tcvg13-es.aspx" id="ctl00_PlaceHolderMain_pageTools_linkFB" target="_blank" title="Share this Page"><span class="icon icon-facebook"></span></a></li>
...
<li><a href="//www.linkedin.com/shareArticle?mini=true&url=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2FPages%2Fvigilancia-seguridad-operacional-tcvg13-es.aspx" id="ctl00_PlaceHolderMain_pageTools_linkLinkedIn" target="_blank"><span class="icon icon-linkedin"></span></a></li>
<li><a href="mailto:?subject=I wanted you to see this site&amp;body=Check out this site http://www.iata.org/training/courses/Pages/vigilancia-seguridad-operacional-tcvg13-es.aspx" id="ctl00_PlaceHolderMain_pageTools_linkMail" title="Share by Email"><span class="icon icon-enveloppeRound"></span></a></li>
</ul>
</div>
</div>
</div>
...
<span id="ctl00_PlaceHolderMain_cpMainContentTitle_ctl00_otherLanguageCourses_lblOtherCoureses"><a href='/training/courses/Pages/safety-oversight-function-tcvg13.aspx' target='_blank'>This course is also available in English.</a><br /><br /></span>
...
<span id="ctl00_PlaceHolderMain_TabContainer1_TabPanel1_trainingSocioEconomics_lblTrainingSocioEconomics">¿Sabías que en los últimos 5 años,<strong> 368 participantes de 30 países </strong> han tomado este curso con IATA?<br /></span>
...
<p><em></em>Entender los principales aspectos de la vigilancia de la seguridad operacional en el ámbito de la aviación civil y examinar la evolución del papel del Programa Universal de Vigilancia de la Seguridad Operacional (USOAP) de la OACI como parte del Programa de Seguridad Operacional del Estado que exige el Anexo 19 de la OACI, Gestión de la seguridad operacional.</p>
...
</ul> <p> Este curso está disponible en <a href="/training/delivery/Pages/classroom-training-centers.aspx" target="_blank"> Centros de Formación IATA </a>, <a href="/training/Pages/regional_training_centres.aspx" target="_blank"> ubicaciones de formación regional de socios</a>, y por encargo como <a href="/training/delivery/Pages/in-company.aspx" target="_blank"> formación en empresa</a> </p><h3>Prerequisitos </h3><li>El nivel recomendado es Principiante y Intermedio</li><li>El nivel recomendado de competencia lingüística es <a href="http&#58;//www.iata.org/training/Documents/ICAO-Language-Proficiency-Requirements.pdf"> ICAO Nivel 4 operativo</a> para cursos en inglés o equivalente para otros idiomas.</li>
</span></span>
<h3></h3>
...
<h4>Objetivos</h4><p>Al finalizar este curso dispondrá de las capacidades necesarias para&#58;</p><ul><li>Comprender el cambio de enfoque en materia de gestión de la seguridad operacional por parte de los Estados con la adopción del Anexo 19, Gestión de la seguridad operacional</li><li>Conocer el Programa Universal de Auditoría de la Vigilancia de la Seguridad Operacional de la Aviación (USOAP) de la OACI en las CAA</li><li>Comprender de manera adecuada los requerimientos de la vigilancia de la seguridad operacional y su impacto en la función de la vigilancia de la seguridad operacional</li><li>Aplicación de los conceptos y principios</li><li>Satisfacer los hallazgos de la auditoría luego de ser auditado según el Programa Universal de Auditoría de la Vigilancia de la Seguridad Operacional de la Aviación (USOAP) de la OACI<span></span><span></span></li></ul>
</span></span>
...
<h4> Temas principales</h4><ul><li>Revisión del cambio del papel del Programa Estatal de Seguridad Operacional del Estado (SSP) y del Sistema de gestión de la seguridad operacional (SMS)</li><li>Revisión histórica de la función de la vigilancia de la seguridad operacional y del USOAP de la OACI con el fin de entender la evolución de los enfoques y su implementación</li><li>Revisión de los ocho elementos críticos del Sistema de vigilancia de la seguridad operacional con el propósito de entender cómo un enfoque integrado puede mejorar la seguridad operacional</li><li>Entender la aplicación práctica del USOAP de la OACI en las CAA, y las exigencias impuestas a las CAA y otros actores, en el marco de la implementación del enfoque de supervisión continua (CMA)</li><li>Conocer los conceptos de gestión y de los programas que pueden ayudar a los gerentes a garantizar la seguridad en las operaciones cotidianas, incluyendo la implementación obligatoria de un sistema de gestión de la seguridad.</li></ul><p>
<a href="/training/courses/Pages/download-file.aspx?documentName=/training-tcvg13es-vigilancia-seguridad-operacional.pdf&amp;documentID=934" target="_blank"><img src="/training/Icons/dwnl_temario.png" alt="Descargue el temario del curso" /></a>
</p><p><strong>Audienca</strong></p><ul><li>Gerentes a cargo de la vigilancia de la seguridad operacional y de auditorías de las autoridades de la aviación civil.</li><li>Oficiales de seguridad en empresas prestadoras de servicios de la industria de la aviación</li></ul>
</span></span>
...
<h4>Audiencia</h4><p>Este curso se recomienda para&#58;</p><ul><li><span lang="ES-TRAD"></span>Gerentes a cargo de la vigilancia de la seguridad operacional y de auditorías de las autoridades de la aviación civil.</li><li>Oficiales de seguridad en empresas prestadoras de servicios de la industria de la aviación</li></ul>
</span></span>
...
<h4> Información adicional</h4><p><strong>Sobre el Aula de Formación IATA</strong></p><p>Preparamos a más de 10.000 profesionales de la aviación anualmente mediante nuestra red global de Centros de Formación IATA, Socios Regionales de Formación, y en sesiones privadas en empresas. Nuestros cursos de aulas de 200+ se desarrollan usando una visión única de la industria de IATA y son impartidos por Instructores IATA, expertos en sus campos. <a href="http&#58;//www.iata.org/training/Pages/classroom-training-centers.aspx">Más</a></p><p>
...
<div class='hide_element_2e900fe5-d720-4598-911b-5e8720b18046'></div><script type='text/javascript'>CTP.IATA.HideChrome('2e900fe5-d720-4598-911b-5e8720b18046')</script>
<div class='hide_element_b68454ff-37db-40e0-8de9-33f21c1834d8'></div><script type='text/javascript'>CTP.IATA.HideChrome('b68454ff-37db-40e0-8de9-33f21c1834d8')</script>
</div>
</div>
</div>
...
<script type="text/javascript">//<![CDATA[
        ...
        {
            formDigestElement.value = '0x7A39A4E47DABE988A42AA82C391176DE7CDCE75506E07D61B32122E6D87F0FF5FDB019F9395C3279C6626AA30B99657668539896D864CD9689255E090656C8FF,27 Nov 2019 18:11:30 -0000';
...
{
    var initInfo = {editable: false,isEditMode: false,allowWebPartAdder: false,listId: "{0d58168f-feef-45ff-bc51-7b9336e39b71}",itemId: 1126420,recycleBinEnabled: true,enableMinorVersioning: true,enableModeration: false,forceCheckout: false,rootFolderUrl: "\u002ftraining\u002fcourses\u002fPages",itemPermissions:{High:16,Low:196673}};
