...
<meta name="description" content="" /><meta name="robots" content="FOLLOW,INDEX" /><meta name="language" content="Russian" /><title>
	
	Слоты Аэропорта и Координация (Класс, 3 дня)  - IATA Training Course
...
<link rel="canonical" href="https://www.iata.org:443/training/courses/Pages/talm13-ru.aspx" />
...
var guaGmtGlobalRequestUri = "/training/courses/Pages/talm13-ru.aspx";
...
'page' : {
'requestURI' : "/training/courses/Pages/talm13-ru.aspx",
'pageType' : "Home",
'device' : "Desktop",
...
<form method="post" action="./talm13-ru.aspx" id="aspnetForm">
...
<input type="hidden" name="__REQUESTDIGEST" id="__REQUESTDIGEST" value="0xA89440A48ABD5DCB046D178D50E9B90FF9F4DB2C33B7B1FCFA011DEE0BB08C5E6CCCE986997F85B63633BA069D196AFF3BB8620D72C795DCD1D7FC7E985C5B01,27 Nov 2019 17:41:36 -0000" />
...
var _fV4UI=true;var _spPageContextInfo = {webServerRelativeUrl: "\u002ftraining\u002fcourses", webAbsoluteUrl: "https:\u002f\u002fwww.iata.org\u002ftraining\u002fcourses", siteAbsoluteUrl: "https:\u002f\u002fwww.iata.org", serverRequestPath: "\u002ftraining\u002fcourses\u002fPages\u002ftalm13-ru.aspx", layoutsUrl: "_layouts\u002f15", webTitle: "Search Courses", webTemplate: "10020", tenantAppVersion: "0", isAppWeb: false, Has2019Era: true, webLogoUrl: "\u002f_layouts\u002fimages\u002ftitlegraphic.gif", webLanguage: 1033, currentLanguage: 1033, currentUICultureName: "en-US", currentCultureName: "en-US", clientServerTimeDelta: new Date("2019-11-27T17:41:36.6420214Z") - new Date(), siteClientTag: "367$$15.0.5127.1000", crossDomainPhotosEnabled:false, webUIVersion:15, webPermMasks:{High:16,Low:196705},pageListId:"{0d58168f-feef-45ff-bc51-7b9336e39b71}",pageItemId:1345600, pagePersonalizationScope:1, alertsEnabled:true, siteServerRelativeUrl: "\u002f", allowSilverlightPrompt:'True'};document.onreadystatechange=fnRemoveAllStatus; function fnRemoveAllStatus(){removeAllStatus(true)};//]]>
</script>
...
<script language="javascript">
    ...
    function GACode() {
        ...
        _gaq.push(['_trackPageview', '/training/courses/Pages/talm13-ru.aspx?q=' + document.getElementById("SearchTextBox").value + '&cat=Main_Search']);
        */
        return true;
    }
...
<ul>
<li><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2Fpages%2Ftalm13-ru.aspx" id="ctl00_PlaceHolderMain_pageTools_linkFB" target="_blank" title="Share this Page"><span class="icon icon-facebook"></span></a></li>
...
<li><a href="//www.linkedin.com/shareArticle?mini=true&url=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2FPages%2Ftalm13-ru.aspx" id="ctl00_PlaceHolderMain_pageTools_linkLinkedIn" target="_blank"><span class="icon icon-linkedin"></span></a></li>
<li><a href="mailto:?subject=I wanted you to see this site&amp;body=Check out this site http://www.iata.org/training/courses/Pages/talm13-ru.aspx" id="ctl00_PlaceHolderMain_pageTools_linkMail" title="Share by Email"><span class="icon icon-enveloppeRound"></span></a></li>
</ul>
</div>
</div>
</div>
...
<h4>около</h4><p>В связи с ростом авиационных перевозок значительно увеличивается несоответствие между потребностью и реальной пропускной способностью аэропорта. Все возрастающий спрос авиакомпаний на слоты становится важным аспектом деятельности аэропортов, которые не имеют достаточной пропускной способности, чтобы обеспечить эту потребность.</p><p>Предлагаемый курс поможет изучить, как распределять и координировать слоты аэропорта в соответствии с Руководством ИАТА «Всемирные правила по Слотам», общепринятом глобальном стандарте, определяющем политики, принципы и процедуры управления слотами аэропорта. Ознакомит, как применять стандартные процедуры обмена данными, которые описаны в Наставлении ИАТА «Руководство по стандарту Информации по Расписанию», в сообщениях между Авиакомпаниями и Слот Координаторами.</p>
<h4>Формат курса</h4><ul>
<li>Этот классный курс предусматривает 3 дня (24 часов) обучения, предоставляемого официальным инструктором IATA.</li>
</ul>
</span></span>
<h3></h3>
...
<h4>Цели курса</h4><p>По окончании этого курса Вы сможете&#58;</p><ul><li>Распределять слоты в соответствии с требованиями и процедурами для любого из аэропортов уровня 2 или уровня 3</li><li>Применять стандартные процедуры для обмена данными между Авиакомпаниями и Слот Координаторами</li><li>Максимально увеличить способность управления портфолио слотов</li><li>Применять слот-процедуры и понимать влияние международных норм и правил</li><li>Использовать слот-сообщения в соответствии с Главой 6 Наставления ИАТА «Руководство по стандарту Информации по Расписанию»</li><li>Анализировать ограничения пропускной способности и данные, необходимые для закрепления слотов на основе «исторического права»<span></span></li></ul>
</span></span>
...
<h4>Ключевые темы</h4><ul><li>Руководство ИАТА «Всемирные правила по Слотам»  Принципы распределения слотов  Политика, спрос и пропускная способность ▪ Процесс координации Аэропорта Уровни Аэропортов и их процедуры</li><li>Международные нормы и правила</li><li>Ограничения пропускной способности и слот-процедуры</li><li>Жалобы и права обжалования</li><li>Глава 6 Наставления ИАТА «Руководство по стандарту Информации по Расписанию»</li><li>Слот-Мониторинг и Процедуры координации</li><li>Список Исторических Слотов<span></span></li></ul><p>
<a href="/training/courses/Pages/download-file.aspx?documentName=/training-talm13ru-airport-slots-coordination.pdf&amp;documentID=1082" target="_blank"><img src="/training/Icons/dwnl_ru.png" alt="Загрузить контур курса" /></a>
</p><p><strong>Действия</strong><br></p><ul><li>Практические упражнения</li></ul>
</span></span>
...
<h4>Целевая аудитория</h4><ul><li>Менеджеры Авиакомпании и персонал, занимающийся планированием маршрутной сети</li><li>Персонал, занимающийся слот- координацией Аэропорта</li><li>Персонал Гражданской Авиации</li><li>Обслуживающие Агентства</li><li>Персонал Аэропорта<span></span></li></ul>
</span></span>
...
<h4>Сертификат Награждена</h4><p>ИАТА Сертификат об окончании присуждается участникам получения оценки 70% или выше на всех упражнениях и экзаменах. Особое различие Награждаются участники получения оценки 90% или выше.</p>
</span></span>
...
<h4>Дополнительная информация</h4><p>О классе обучения IATA<br>Ежегодно мы обучаем более 10 000 авиационных специалистов через нашу глобальную сеть учебных центров ИАТА, региональных партнеров по обучению и частных сессий. Наши 200+ классные курсы разработаны с использованием уникальной отраслевой проницательности ИАТА и <a href="http&#58;//www.iata.org/training/Pages/classroom-training-centers.aspx"> доставляются инструкторами IATA </a>, экспертами в своих областях. Больше</p><p>Дальнейшая подготовка<br>Выпускники этого курса могут подать заявку на программу дистанционного обучения <a href="http&#58;//training.iata.org/products/4896">Harvard ManageMentor © (HMM) </a>по специальной цене выпускника.</p>
</span></span>
<h3></h3>
...
<p>
<h4>Как зарегистрироваться</h4><p>Чтобы организовать этот класс для своей компании&#58; <a href="http&#58;//www.iata.org/training/Pages/in-company.aspx">заполните контактную форму</a> или свяжитесь с продавцом в вашем регионе <a href="http&#58;//www.iata.org/training/Pages/in-company.aspx" target="_blank">по телефону или факсу</a>.</p><p>Чтобы посещать занятия, запланированные в одном из наших учебных центров&#58; выберите нужный класс из списка ниже, чтобы начать работу. Зарегистрируйтесь рано и <a href="http&#58;//www.iata.org/training/pages/earlybird.aspx" target="_blank">сэкономьте до 20%</a>! Пожалуйста, ознакомьтесь с Условиями скидки «early bird». Скидка будет рассчитываться во время оплаты.</p><h3>ценообразование</h3>Для получения дополнительной информации о нашей структуре ценообразования посетите нашу <a href="http&#58;//www.iata.org/training/Pages/pricing.aspx" target="_blank">страницу ценообразования</a>
</p>
<script type='text/javascript'>
    function openLMS(lmsUrl) {
...
<div class='hide_element_ea5d3135-3df0-44a0-9441-1b536632669b'></div><script type='text/javascript'>CTP.IATA.HideChrome('ea5d3135-3df0-44a0-9441-1b536632669b')</script>
<div class='hide_element_9a5241e4-89b2-4ad7-8edc-b2d52d52c773'></div><script type='text/javascript'>CTP.IATA.HideChrome('9a5241e4-89b2-4ad7-8edc-b2d52d52c773')</script>
</div>
</div>
</div>
...
<script type="text/javascript">//<![CDATA[
        ...
        {
            formDigestElement.value = '0xCB3019FF377FF6979932E2D3A6DDD15F74045DCA0CBE25DC09232FB4114FD7B659D605CE1454E9823829F33C4ECD2E29D96A4D638DC8DA508553F57F9BC9F1AB,27 Nov 2019 17:41:37 -0000';
...
{
    var initInfo = {editable: false,isEditMode: false,allowWebPartAdder: false,listId: "{0d58168f-feef-45ff-bc51-7b9336e39b71}",itemId: 1345600,recycleBinEnabled: true,enableMinorVersioning: true,enableModeration: false,forceCheckout: false,rootFolderUrl: "\u002ftraining\u002fcourses\u002fPages",itemPermissions:{High:16,Low:196673}};
