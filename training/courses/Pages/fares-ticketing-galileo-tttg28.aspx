...
<meta name="keywords" content='Fares, mileage, construction, components, FCP, HIP, CTM, BHC, RTW, round-the-world, NUC, currency conversion, rules, GDS, LCP, e-tickets, side-trips, open jaw, formula, circle trip, aviation, training, course' />
<meta name="description" content="<p>
	Explore and interpret Global Distribution Systems Fares (GDS) by using mileage system pricing</p>" /><meta name="robots" content="FOLLOW,INDEX" /><title>
	
	Global Distribution Systems Fares and Ticketing - GALILEO  - IATA Training Course
...
<link rel="canonical" href="https://www.iata.org:443/training/courses/Pages/fares-ticketing-galileo-tttg28.aspx" />
...
var guaGmtGlobalRequestUri = "/training/courses/Pages/fares-ticketing-galileo-tttg28.aspx";
var guaGmtGlobalPageTitle = "TTTG-28";
...
'page' : {
'requestURI' : "/training/courses/Pages/fares-ticketing-galileo-tttg28.aspx",
'pageType' : "Home",
'device' : "Desktop",
...
<form method="post" action="./fares-ticketing-galileo-tttg28.aspx" id="aspnetForm">
...
<input type="hidden" name="__REQUESTDIGEST" id="__REQUESTDIGEST" value="0x1A0BC3400862B8A0F93C18633BFF1BB2E0DD4EB6246AAAF74BA59593947D1D82317EE092292A519941B24583A91FB2BCB4AAF6CD23AA6A0DE73C6EB3351000CB,27 Nov 2019 18:12:32 -0000" />
...
var _fV4UI=true;var _spPageContextInfo = {webServerRelativeUrl: "\u002ftraining\u002fcourses", webAbsoluteUrl: "https:\u002f\u002fwww.iata.org\u002ftraining\u002fcourses", siteAbsoluteUrl: "https:\u002f\u002fwww.iata.org", serverRequestPath: "\u002ftraining\u002fcourses\u002fPages\u002ffares-ticketing-galileo-tttg28.aspx", layoutsUrl: "_layouts\u002f15", webTitle: "Search Courses", webTemplate: "10020", tenantAppVersion: "0", isAppWeb: false, Has2019Era: true, webLogoUrl: "\u002f_layouts\u002fimages\u002ftitlegraphic.gif", webLanguage: 1033, currentLanguage: 1033, currentUICultureName: "en-US", currentCultureName: "en-US", clientServerTimeDelta: new Date("2019-11-27T18:12:32.9342671Z") - new Date(), siteClientTag: "367$$15.0.5127.1000", crossDomainPhotosEnabled:false, webUIVersion:15, webPermMasks:{High:16,Low:196705},pageListId:"{0d58168f-feef-45ff-bc51-7b9336e39b71}",pageItemId:1109, pagePersonalizationScope:1, alertsEnabled:true, siteServerRelativeUrl: "\u002f", allowSilverlightPrompt:'True'};document.onreadystatechange=fnRemoveAllStatus; function fnRemoveAllStatus(){removeAllStatus(true)};//]]>
</script>
...
<script language="javascript">
    ...
    function GACode() {
        ...
        _gaq.push(['_trackPageview', '/training/courses/Pages/fares-ticketing-galileo-tttg28.aspx?q=' + document.getElementById("SearchTextBox").value + '&cat=Main_Search']);
        */
        return true;
    }
...
<ul>
<li><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2Fpages%2Ffares-ticketing-galileo-tttg28.aspx" id="ctl00_PlaceHolderMain_pageTools_linkFB" target="_blank" title="Share this Page"><span class="icon icon-facebook"></span></a></li>
...
<li><a href="//www.linkedin.com/shareArticle?mini=true&url=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2FPages%2Ffares-ticketing-galileo-tttg28.aspx" id="ctl00_PlaceHolderMain_pageTools_linkLinkedIn" target="_blank"><span class="icon icon-linkedin"></span></a></li>
<li><a href="mailto:?subject=I wanted you to see this site&amp;body=Check out this site http://www.iata.org/training/courses/Pages/fares-ticketing-galileo-tttg28.aspx" id="ctl00_PlaceHolderMain_pageTools_linkMail" title="Share by Email"><span class="icon icon-enveloppeRound"></span></a></li>
 </ul>
</div>
</div>
</div>
...
Global Distribution Systems Fares and Ticketing - GALILEO
</h1>
...
<p>This interactive e-learning course will teach you how to price journeys for all types of fares using the Galileo Global Distribution Systems (GDS). You will have hands-on practise using the interactive Global Distribution Systems (GDS) simulation tool, which will help you analyze GDS displays relevant to mileage system pricing; read, interpret, and apply mileage and routing fare rules; and issue tickets. The simulation training is supported by an interactive workbook and reference notes on GDS commands, maps and key journey pricing terms and definitions.</p>
</span></span>
<span id="ctl00_PlaceHolderMain_TabContainer1_TabPanel1_ConditionalPanel3"><span>
<h3>Course format</h3>This course is available in e-learning format. Enrol at an <a href="/training/Pages/partner-network.aspx">Authorized Training Center</a> to study these materials with the help of a local trainer, or alternatively you can choose to study these materials on your own.<ul>
<li> This course requires approximately 50 hours of study to be completed in 12 months from the purchase date (enrollment validity). After the enrollment validity expires, the users will not have access to the course content and will not be able to take the exam.</li><li>This is computer-based, interactive simulation training,
accompanied by an interactive workbook and reference notes on GDS
commands, maps and key journey pricing terms and definitions.</li><ul>
</ul>
<li>Student performance will be based on an examination. Please refer to the <a href="#ExamInfo">Exam Information</a> below for more details.</li></ul><h3>Prerequisites</h3>Learners must already be familiar with GDS system functionality, basic commands, and have the ability to interpret booked itineraries.
</span></span>
...
<li>Analyze GDS displays relevant to mileage system pricing</li><li>Identify and price different journey types</li><li>Read, interpret, and apply mileage and routing fare rules</li><li>Issue tickets</li></ul>
</span></span>
...
<ul>
<li>Introduction to air fares, analysing itineraries and retrieving fares from a GDS</li><li>Limitations on indirect travel, side trips and surface sectors</li><li>Return trips in different classes of service and alternative fare break points</li><li>Lowest combinations, round-the-world journeys and class differentials</li></ul><p>
<a href="/training/courses/Pages/download-file.aspx?documentName=/training-tttg28-gds-fares-galileo.pdf&amp;documentID=1229" target="_blank"><img src="/training/Icons/dwnl_outline.png" alt="Download the course outline" /></a>
</p>
</span></span>
...
<p>This course is recommended for&#58;</p><ul><li>Airline fares desk agents</li><li>Travel agents</li><li>Airline ticket agents</li><li>Business Process Outsourcing (BPO) and call center agents</li></ul>
</span></span>
...
<p>An IATA Certificate is awarded to participants successfully passing the final exam.</p><h3>Exam information</h3><a name="ExamInfo"></a> <p>Please read the <a href="https://www.iata.org/training/Pages/exam-information.aspx">General Information</a> on Partner-taught / Self-study exams, and check the <a href="/training/Documents/training-exam-course-edition-list.pdf">Course edition list for exams</a> when booking your exam.</p><ul>
<li>Exam Method&#58; <a href="http&#58;//www.iata.org/training/Pages/exam-information.aspx">Online exam with remote supervision </a>or an <a href="/training/Pages/exam-location.aspx">exam in one of IATA’s Exam Centers</a> (where physical presence is required)</li>
<li>Exam Format&#58; Multiple Choice questions. Open Text Book</li>
<li>Number of questions&#58; 100</li>
<li>Time Allowance&#58; 3 hours</li>
<li>Passing Grade&#58; 60 correct answers</li><li>Distinction Grade&#58; 85 correct answers</li><li>Number of exam attempts&#58; 2</li>
</ul>
</span></span>
...
<li><a href="https://www.iata.org/training/subject-areas/Pages/travel-tourism-courses.aspx">Travel and tourism</a></li><li><a href="https://www.iata.org/training/subject-areas/Pages/fares-ticketing-courses.aspx">Fares and ticketing</a></li>
</ul>
</td>
</tr>
</table>
...
<tr>
<td><strong>Note: </strong><p>Learn tariff resolutions and construct air fares by using simulated GDS functionality. <br></p></td>
...
<td><strong><span id="ctl00_PlaceHolderMain_TabContainer1_TabPanel3_DistanceLearningDetails_EnrolLink"><INPUT type='button' value='Buy ebook' class='primaryBtn' onclick="window.open('http://training.iata.org/purchases/new?sitting_id=&product_id=701', '_blank')"></span><strong></td>
</tr>
</tbody>
</thead>
</table>
...
<div id="ctl00_PlaceHolderMain_RichHtmlFieldIATAHighlightInformation_label" style='display:none'>IATAHighlightInformation</div><div id="ctl00_PlaceHolderMain_RichHtmlFieldIATAHighlightInformation__ControlWrapper_RichHtmlField" class="ms-rtestate-field" style="display:inline" aria-labelledby="ctl00_PlaceHolderMain_RichHtmlFieldIATAHighlightInformation_label"><p>​<a href="/training/courses/Pages/fares-ticketing-amadeus-tttg26.aspx">Global Distribution System Fares and Ticketing - Amadeus</a> </p><p>​<a href="/training/courses/Pages/fares-ticketing-sabre-tttg29.aspx">Global Distribution System Fares and Ticketing - Sabre</a><br></p></div>
</div>
<div class='hide_element_66a98d65-47c1-4eb7-953d-059bea6e4a95'></div><script type='text/javascript'>CTP.IATA.HideChrome('66a98d65-47c1-4eb7-953d-059bea6e4a95')</script>
<div class='hide_element_1fde78d6-31d7-432c-b614-a846e6f504df'></div><script type='text/javascript'>CTP.IATA.HideChrome('1fde78d6-31d7-432c-b614-a846e6f504df')</script>
</div>
</div>
</div>
...
<script type="text/javascript">//<![CDATA[
        ...
        {
            formDigestElement.value = '0xFFDE71E13FCD61BF24AEB0F9078D9578DD4E04BDD7437D192BDDA626A81E8AC2756A19CF97AB621C2724AEC8ABFEBB779389EEA5CBB7E1232F7F7DAE53D5C14D,27 Nov 2019 18:12:33 -0000';
...
{
    var initInfo = {editable: false,isEditMode: false,allowWebPartAdder: false,listId: "{0d58168f-feef-45ff-bc51-7b9336e39b71}",itemId: 1109,recycleBinEnabled: true,enableMinorVersioning: true,enableModeration: false,forceCheckout: false,rootFolderUrl: "\u002ftraining\u002fcourses\u002fPages",itemPermissions:{High:16,Low:196673}};
