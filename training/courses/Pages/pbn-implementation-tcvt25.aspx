...
<meta name="keywords" content='ICAO, Performance-based Navigation, PBN,  area navigation, RNAV, GNSS, Global Navigation Satellite System, precision approach, non-precision approach, conventional navigation, Aeronautical Information Circulars, NavSpecs, airworthiness certification' />
<meta name="description" content="<p>
	Understand the implementation and operational approval activities required to make Performance-based Navigation (PBN) work.</p>" /><meta name="robots" content="FOLLOW,INDEX" /><title>
	
	Performance-Based Navigation (PBN) Implementation Workshop (Classroom, 5 days)  - IATA Training Course
...
<link rel="canonical" href="https://www.iata.org:443/training/courses/Pages/pbn-implementation-tcvt25.aspx" />
...
var guaGmtGlobalRequestUri = "/training/courses/Pages/pbn-implementation-tcvt25.aspx";
var guaGmtGlobalPageTitle = "TCVT-25";
...
'page' : {
'requestURI' : "/training/courses/Pages/pbn-implementation-tcvt25.aspx",
'pageType' : "Home",
'device' : "Desktop",
...
<form method="post" action="./pbn-implementation-tcvt25.aspx" id="aspnetForm">
...
<input type="hidden" name="__REQUESTDIGEST" id="__REQUESTDIGEST" value="0x17957C875E00BEC6FBDAF6BB773E01A33A76C882558FE6364EA5A2C9C9192593379BF4EC7328E98F2B9C251A23F19FE2CE100CCAC47A4B2D376F467D0F50F566,27 Nov 2019 18:09:09 -0000" />
...
var _fV4UI=true;var _spPageContextInfo = {webServerRelativeUrl: "\u002ftraining\u002fcourses", webAbsoluteUrl: "https:\u002f\u002fwww.iata.org\u002ftraining\u002fcourses", siteAbsoluteUrl: "https:\u002f\u002fwww.iata.org", serverRequestPath: "\u002ftraining\u002fcourses\u002fPages\u002fpbn-implementation-tcvt25.aspx", layoutsUrl: "_layouts\u002f15", webTitle: "Search Courses", webTemplate: "10020", tenantAppVersion: "0", isAppWeb: false, Has2019Era: true, webLogoUrl: "\u002f_layouts\u002fimages\u002ftitlegraphic.gif", webLanguage: 1033, currentLanguage: 1033, currentUICultureName: "en-US", currentCultureName: "en-US", clientServerTimeDelta: new Date("2019-11-27T18:09:09.0577173Z") - new Date(), siteClientTag: "367$$15.0.5127.1000", crossDomainPhotosEnabled:false, webUIVersion:15, webPermMasks:{High:16,Low:196705},pageListId:"{0d58168f-feef-45ff-bc51-7b9336e39b71}",pageItemId:926, pagePersonalizationScope:1, alertsEnabled:true, siteServerRelativeUrl: "\u002f", allowSilverlightPrompt:'True'};document.onreadystatechange=fnRemoveAllStatus; function fnRemoveAllStatus(){removeAllStatus(true)};//]]>
</script>
...
<script language="javascript">
    ...
    function GACode() {
        ...
        _gaq.push(['_trackPageview', '/training/courses/Pages/pbn-implementation-tcvt25.aspx?q=' + document.getElementById("SearchTextBox").value + '&cat=Main_Search']);
        */
        return true;
    }
...
<ul>
<li><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2Fpages%2Fpbn-implementation-tcvt25.aspx" id="ctl00_PlaceHolderMain_pageTools_linkFB" target="_blank" title="Share this Page"><span class="icon icon-facebook"></span></a></li>
...
<li><a href="//www.linkedin.com/shareArticle?mini=true&url=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2FPages%2Fpbn-implementation-tcvt25.aspx" id="ctl00_PlaceHolderMain_pageTools_linkLinkedIn" target="_blank"><span class="icon icon-linkedin"></span></a></li>
<li><a href="mailto:?subject=I wanted you to see this site&amp;body=Check out this site http://www.iata.org/training/courses/Pages/pbn-implementation-tcvt25.aspx" id="ctl00_PlaceHolderMain_pageTools_linkMail" title="Share by Email"><span class="icon icon-enveloppeRound"></span></a></li>
</ul>
</div>
</div>
</div>
...
<li>
Incorporate the use of Performance-based Navigation, area navigation systems and GNSS in your daily work</li> <li>
Be conversant about PBN designated airspace, PBN designated ATS routes and approaches, Operational Approvals, NavSpecs, airworthiness certification type documents (FAA Orders, Advisory Circulars (ACs), EASA Acceptable Means of Compliance (AMC), and Temporary Guidance Leaflets (TGL)</li></ul>
</span></span>
...
<ul><li>Historical and technical aspects of PBN</li>
<ul><li>The concept of PBN</li><li>
The PBN Manual</li><li>
Basic theory of area navigation and area navigation systems, in particular GNSS</li></ul> <li>Structure of navigation specifications (NavSpecs)</li><li>Introduction to implementation</li>
<ul><li>Air Navigation Service Provider roles and responsibilities</li><li>
Implementation checklist for ANSPs</li></ul> <li>Introduction to operational approvals</li>
<ul><li>Evolution of operational approvals</li><li>
Operational approval process</li><li>
Step by step checklist</li><li>
Avionics service letters</li></ul> <li>NavSpecs and applicable AC, AMC and TGL documentation</li>
<ul><li>Review of AFM Statements</li><li>
Regulator, CAA, POI responsibilities</li><li>
Job aid for RNAV 1/RNP APCH approval process</li></ul> <li>Exercises</li>
<ul><li>Review of foreign operators in country capabilities</li><li>
Review of the country’s domestic air operators capabilities</li></ul> </ul>
</span></span>
...
Airline managers and operational staff</li></ul>
</span></span>
...
<div class='hide_element_5be1b74e-9787-4fc5-a362-be9112d81549'></div><script type='text/javascript'>CTP.IATA.HideChrome('5be1b74e-9787-4fc5-a362-be9112d81549')</script>
<div class='hide_element_6b770cb0-8ade-4101-9395-d2f7e5ac19b5'></div><script type='text/javascript'>CTP.IATA.HideChrome('6b770cb0-8ade-4101-9395-d2f7e5ac19b5')</script>
</div>
</div>
</div>
...
<script type="text/javascript">//<![CDATA[
        ...
        {
            formDigestElement.value = '0x877E8367C5E2C72BEA6D365802A638646C231C86CC134213619092F282153E466546119DFB513F129E3798A7F97414071193120346E5342838F7BACE02A4162A,27 Nov 2019 18:09:10 -0000';
...
{
    var initInfo = {editable: false,isEditMode: false,allowWebPartAdder: false,listId: "{0d58168f-feef-45ff-bc51-7b9336e39b71}",itemId: 926,recycleBinEnabled: true,enableMinorVersioning: true,enableModeration: false,forceCheckout: false,rootFolderUrl: "\u002ftraining\u002fcourses\u002fPages",itemPermissions:{High:16,Low:196673}};
