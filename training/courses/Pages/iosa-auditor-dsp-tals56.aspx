...
<meta name="keywords" content='compliance, conformance, iosa, standards, iosa standards manual, dsp, operational control, line operations, performance-based compliance, flight following, monitoring, watch, tools, isarps requirements, interpretation, aviation, training, course' />
<meta name="description" content="<p>Focussing on the IOSA discipline - Operational Control and Flight Dispatch (DSP), you will be equipped with the knowledge and skills to perform internal audits using the IOSA DSP checklist.</p>" /><meta name="robots" content="FOLLOW,INDEX" /><title>
	
	IOSA Airline Auditor – Operational Control and Flight Dispatch (DSP) Discipline (Classroom, 2 days)  - IATA Training Course
...
<link rel="canonical" href="https://www.iata.org:443/training/courses/Pages/iosa-auditor-dsp-tals56.aspx" />
...
var guaGmtGlobalRequestUri = "/training/courses/Pages/iosa-auditor-dsp-tals56.aspx";
var guaGmtGlobalPageTitle = "TALS-56";
...
'page' : {
'requestURI' : "/training/courses/Pages/iosa-auditor-dsp-tals56.aspx",
'pageType' : "Home",
'device' : "Desktop",
...
<form method="post" action="./iosa-auditor-dsp-tals56.aspx" id="aspnetForm">
...
<input type="hidden" name="__REQUESTDIGEST" id="__REQUESTDIGEST" value="0xB5DDF86A11C70A3C81FBC4EF6CFC0497A7A0DB86CF1F92E4718F723276B7749A582C8EBB5F595C6E741C7170D7E78FF9FFBBDE3753A44A480B922910A99DBF91,27 Nov 2019 20:20:21 -0000" />
...
var _fV4UI=true;var _spPageContextInfo = {webServerRelativeUrl: "\u002ftraining\u002fcourses", webAbsoluteUrl: "https:\u002f\u002fwww.iata.org\u002ftraining\u002fcourses", siteAbsoluteUrl: "https:\u002f\u002fwww.iata.org", serverRequestPath: "\u002ftraining\u002fcourses\u002fPages\u002fiosa-auditor-dsp-tals56.aspx", layoutsUrl: "_layouts\u002f15", webTitle: "Search Courses", webTemplate: "10020", tenantAppVersion: "0", isAppWeb: false, Has2019Era: true, webLogoUrl: "\u002f_layouts\u002fimages\u002ftitlegraphic.gif", webLanguage: 1033, currentLanguage: 1033, currentUICultureName: "en-US", currentCultureName: "en-US", clientServerTimeDelta: new Date("2019-11-27T20:20:21.1982010Z") - new Date(), siteClientTag: "367$$15.0.5127.1000", crossDomainPhotosEnabled:false, webUIVersion:15, webPermMasks:{High:16,Low:196705},pageListId:"{0d58168f-feef-45ff-bc51-7b9336e39b71}",pageItemId:1142627, pagePersonalizationScope:1, alertsEnabled:true, siteServerRelativeUrl: "\u002f", allowSilverlightPrompt:'True'};document.onreadystatechange=fnRemoveAllStatus; function fnRemoveAllStatus(){removeAllStatus(true)};//]]>
</script>
...
<script language="javascript">
    ...
    function GACode() {
        ...
        _gaq.push(['_trackPageview', '/training/courses/Pages/iosa-auditor-dsp-tals56.aspx?q=' + document.getElementById("SearchTextBox").value + '&cat=Main_Search']);
        */
        return true;
    }
...
<ul>
<li><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2Fpages%2Fiosa-auditor-dsp-tals56.aspx" id="ctl00_PlaceHolderMain_pageTools_linkFB" target="_blank" title="Share this Page"><span class="icon icon-facebook"></span></a></li>
...
<li><a href="//www.linkedin.com/shareArticle?mini=true&url=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2FPages%2Fiosa-auditor-dsp-tals56.aspx" id="ctl00_PlaceHolderMain_pageTools_linkLinkedIn" target="_blank"><span class="icon icon-linkedin"></span></a></li>
<li><a href="mailto:?subject=I wanted you to see this site&amp;body=Check out this site http://www.iata.org/training/courses/Pages/iosa-auditor-dsp-tals56.aspx" id="ctl00_PlaceHolderMain_pageTools_linkMail" title="Share by Email"><span class="icon icon-enveloppeRound"></span></a></li>
</ul>
</div>
</div>
</div>
...
IOSA Airline Auditor – Operational Control and Flight Dispatch (DSP) Discipline (Classroom, 2 days)
</h1><br />
...
<p>Following the <a href="http&#58;//www.iata.org/training/courses/Pages/iosa-airline-auditor-tals52.aspx">IOSA Airline Auditor Training</a>, this course focuses on the IOSA discipline - Operational Control and Flight Dispatch (DSP), which ensures that you will be equipped with the knowledge and skills to perform internal audits using the IOSA DSP checklist. You will learn how to interpret IOSA Standards and Recommended Practices (ISARPs) and find out about the challenges you may encounter when conducting internal assessments against DSP ISARPs.</p><p>This course is available at <a href="/training/delivery/Pages/classroom-training-centers.aspx" target="_blank">IATA Training Centers</a>, <a href="/training/Pages/regional_training_centres.aspx" target="_blank">Regional Training Partner locations</a>, and on-demand as <a href="/training/delivery/Pages/in-company.aspx" target="_blank">in-house training</a>.<br></p>
<h3>Course format</h3><ul>
<li>This classroom course provides 2 days (16 hours) of instruction delivered by an official IATA Instructor.</li><li>Student performance will be based on an <a href="http&#58;//www.iata.org/training/Documents/IATA-Training-Grading-Policy.pdf">assessment</a></li>
</ul><h3>Prerequisites </h3><ul>
<li>Participants should have previous IOSA Program and airline auditing knowledge and experience</li><li>Recommended level is Management and Professional</li>
...
<tr>
<td><span>Jun 15 - Jun 16, 2020 - United Kingdom, London (IATA)</br></span><a href="http://training.iata.org/purchases/new?sitting_id=109782&product_id=4271" target="_blank"><img src="/events/Images1/buttons/register-button.png" alt="Register" style="margin:5px;"></a><br></td>
</tr>
</table>
</div>
</td>
...
<p>Upon completion of this course you will be able to&#58;</p><ul><li>Interpret and apply the IOSA DSP checklists in internal audits</li><li>Distinguish the philosophy behind the development of IOSA Standards Manual (ISM) - Section 3 - DSP</li><li>Identify key terms used in the IOSA Standards Manual (ISM) - Section 3 – DSP for the purpose of effectively applying ISARPS</li><li>Summarize the certification, training and knowledge requirements of the various personnel functions that relate to Flight Dispatch</li><li>Use auditor actions<span></span></li></ul>
</span></span>
...
<ul><li> Historical perspective; ‘Compliance’ and ‘Conformance’</li><li>Philosophy underlying IOSA Standards Manual (ISM) Section 3 - DSP</li><li>New technical terms in the industry</li><li>Operational control<ul><li>Problems encountered during line operations</li></ul></li><li>Prescriptive and performance-based compliance</li><li>Flight Following, Monitoring and Watch
<ul><li>Tools used in Flight Following</li></ul></li><li>IOSA Standards and Recommend Practices (ISARPs) analysis
<ul><li>ISARPs’ requirements and interpretation<span></span></li></ul></li></ul><p>
<a href="/training/courses/Pages/download-file.aspx?documentName=/training-tals56-iosa-airline-auditor-dsp.pdf&amp;documentID=949" target="_blank"><img src="/training/Icons/dwnl_outline.png" alt="Download the course outline" /></a>
</p><p><strong>Activities</strong><br></p><ul><li>Role play</li><li>Exercises<span></span></li></ul>
</span></span>
...
<p>This course is recommended for&#58;</p><ul><li>Operational Control and Flight Dispatch professionals</li><li>Quality managers and analysts</li><li>IOSA analysts and coordinators</li><li>Airline internal auditors<span></span></li></ul>
 </span></span>
...
Class no : 109782</span></td>
<td>Jun 15 - Jun 16, 2020
<br>
...
<a href='http://training.iata.org/purchases/new?sitting_id=109782&product_id=4271' style='float:right;' class='primaryBtn' target='_blank'> Register </a>
</td>
</tr>
...
<span style="font-weight:normal; font-size:8pt;">
Class no : 109783</span></td>
<td>Nov 02 - Nov 03, 2020
<br>
<span style="text-align:right;padding-right:9px;color:#028FD7;"> </span>
</td>
<td style="text-align:right;padding-right:9px;"><a href="#" class="cldisplay" style="color:red;">See prices & register</a></td>
...
<td></td>
<td colspan="3" class="gray">
<a href='http://training.iata.org/purchases/new?sitting_id=109783&product_id=4271' style='float:right;' class='primaryBtn' target='_blank'> Register </a>
</td>
</tr>
<tr sizset="61" sizcache="8">
<td sizset="61" sizcache="8" colspan="2">
...
<div class='hide_element_f4d9b625-cd56-4d89-9190-3bd970d391b3'></div><script type='text/javascript'>CTP.IATA.HideChrome('f4d9b625-cd56-4d89-9190-3bd970d391b3')</script>
<div class='hide_element_e3002102-7722-4c77-ae47-d5ff88303b66'></div><script type='text/javascript'>CTP.IATA.HideChrome('e3002102-7722-4c77-ae47-d5ff88303b66')</script>
</div>
</div>
</div>
...
<script type="text/javascript">//<![CDATA[
        ...
        {
            formDigestElement.value = '0x975332CDA625698C8008B823EA397E3BE690B4DB7C8CD0A3DBA11BCEA766AE334783D5345D50D84446152DC8ED2DB9E7A47E606CD7B8756682593B6C375393D5,27 Nov 2019 20:20:22 -0000';
...
{
    var initInfo = {editable: false,isEditMode: false,allowWebPartAdder: false,listId: "{0d58168f-feef-45ff-bc51-7b9336e39b71}",itemId: 1142627,recycleBinEnabled: true,enableMinorVersioning: true,enableModeration: false,forceCheckout: false,rootFolderUrl: "\u002ftraining\u002fcourses\u002fPages",itemPermissions:{High:16,Low:196673}};
