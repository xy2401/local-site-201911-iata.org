...
<meta name="keywords" content='customer service, travel industry, communication, customer, technology, customer loyalty, difficult customers, work stress, training, course, aviation' />
<meta name="description" content="<p>Gain essential strategies to ensure that the customer’s level of satisfaction will influence a purchase or repurchase decision.</p>" /><meta name="robots" content="FOLLOW,INDEX" /><title>
	
	Serving the Travel Customer  - IATA Training Course
...
<link rel="canonical" href="https://www.iata.org:443/training/courses/Pages/serving-travel-customer-tttg66.aspx" />
...
var guaGmtGlobalRequestUri = "/training/courses/Pages/serving-travel-customer-tttg66.aspx";
var guaGmtGlobalPageTitle = "TTTG-66";
...
'page' : {
'requestURI' : "/training/courses/Pages/serving-travel-customer-tttg66.aspx",
'pageType' : "Home",
'device' : "Desktop",
...
<form method="post" action="./serving-travel-customer-tttg66.aspx" id="aspnetForm">
...
<input type="hidden" name="__REQUESTDIGEST" id="__REQUESTDIGEST" value="0xAC38492C329F0160F90BC67FDDE9BA5962173B9E4C07B2C32F4E499E50BD8C7D00A32A98D6B9ABF23FC4ECF80BB2AAD6C77F07C8317F74248211B5DAD9ECDE31,27 Nov 2019 18:12:42 -0000" />
...
var _fV4UI=true;var _spPageContextInfo = {webServerRelativeUrl: "\u002ftraining\u002fcourses", webAbsoluteUrl: "https:\u002f\u002fwww.iata.org\u002ftraining\u002fcourses", siteAbsoluteUrl: "https:\u002f\u002fwww.iata.org", serverRequestPath: "\u002ftraining\u002fcourses\u002fPages\u002fserving-travel-customer-tttg66.aspx", layoutsUrl: "_layouts\u002f15", webTitle: "Search Courses", webTemplate: "10020", tenantAppVersion: "0", isAppWeb: false, Has2019Era: true, webLogoUrl: "\u002f_layouts\u002fimages\u002ftitlegraphic.gif", webLanguage: 1033, currentLanguage: 1033, currentUICultureName: "en-US", currentCultureName: "en-US", clientServerTimeDelta: new Date("2019-11-27T18:12:42.8558527Z") - new Date(), siteClientTag: "367$$15.0.5127.1000", crossDomainPhotosEnabled:false, webUIVersion:15, webPermMasks:{High:16,Low:196705},pageListId:"{0d58168f-feef-45ff-bc51-7b9336e39b71}",pageItemId:1119901, pagePersonalizationScope:1, alertsEnabled:true, siteServerRelativeUrl: "\u002f", allowSilverlightPrompt:'True'};document.onreadystatechange=fnRemoveAllStatus; function fnRemoveAllStatus(){removeAllStatus(true)};//]]>
</script>
...
<script language="javascript">
    ...
    function GACode() {
        ...
        _gaq.push(['_trackPageview', '/training/courses/Pages/serving-travel-customer-tttg66.aspx?q=' + document.getElementById("SearchTextBox").value + '&cat=Main_Search']);
        */
        return true;
    }
...
<ul>
<li><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2Fpages%2Fserving-travel-customer-tttg66.aspx" id="ctl00_PlaceHolderMain_pageTools_linkFB" target="_blank" title="Share this Page"><span class="icon icon-facebook"></span></a></li>
...
<li><a href="//www.linkedin.com/shareArticle?mini=true&url=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2FPages%2Fserving-travel-customer-tttg66.aspx" id="ctl00_PlaceHolderMain_pageTools_linkLinkedIn" target="_blank"><span class="icon icon-linkedin"></span></a></li>
<li><a href="mailto:?subject=I wanted you to see this site&amp;body=Check out this site http://www.iata.org/training/courses/Pages/serving-travel-customer-tttg66.aspx" id="ctl00_PlaceHolderMain_pageTools_linkMail" title="Share by Email"><span class="icon icon-enveloppeRound"></span></a></li>
</ul>
</div>
</div>
</div>
...
<span id="ctl00_PlaceHolderMain_DisplayMainContent_cpMainContentTitle_ctl00_otherLanguageCourses_lblOtherCoureses"><a href='/training/courses/Pages/service-client-voyageur-tttg66-fr.aspx' target='_blank'>Ce cours est aussi disponible en Français.</a><br /><br /></span>
</span></span>
...
<p>Gain essential strategies to ensure that the customer’s level of satisfaction will influence a purchase or repurchase decision by ensuring that your front-line contact with the customer is remarkable.</p><p>In this course you will learn about customer service in the travel industry highlighting its importance in retaining current business while attracting new business. You will also explore fundamental communication skills essential for positive agent-customer interactions, practical ways to stay in touch with travelling customers, and how to win customer loyalty. Learn how to handle difficult or upset customers, how to deal with the reality of stress in the workplace, and coping strategies for travel professionals.</p>
</span></span>
<span id="ctl00_PlaceHolderMain_TabContainer1_TabPanel1_ConditionalPanel3"><span>
<h3>Course format</h3>This course is available in e-textbook format. Enrol with a <a href="http&#58;//www.iata.org/training/Pages/partner-network.aspx">Authorized Training Center </a> to study these materials with the help of a local trainer, or alternatively you can choose to study these materials on your own.<ul>
<li> This course requires approximately 20 hours of study to be completed in 6 months from the purchase date (enrollment validity). After the enrollment validity expires, the users will not have access to the course content and will not be able to take the exam.</li>
...
<p>Upon completing this course you will be able to&#58;</p><ul><li>Explain why good customer service is important in the travel industry</li><li>Define customer service as an integral element in the travel professional’s role</li><li>List effective “do’s and don’ts” when serving customers via different communication channels</li><li>State the benefits of developing customer loyalty and strategies for building customer loyalty</li><li>Identify steps and methods for handling upset customers</li><li>Relate job performance to workplace stress and recommend coping strategies for travel professionals<span></span><span></span></li></ul>
</span></span>
...
<ul><li><span></span>Customer Service in the Travel Industry</li><li>Communicating with Customers</li><li>Customer Service and Technology</li><li>Winning Customer Loyalty</li><li>Handling Difficult Customers</li><li>Coping with Work Stress</li></ul><p>
<a href="/training/courses/Pages/download-file.aspx?documentName=/training-tttg66-serving-travel-customer.pdf&amp;documentID=924" target="_blank"><img src="/training/Icons/dwnl_outline.png" alt="Download the course outline" /></a>
</p>
</span></span>
...
<p>This course is recommended for&#58;</p><ul><li>Travel agents</li><li>Airline reservation or ticket agents</li><li>Tour operators</li><li>Call center agents<span></span></li></ul>
</span></span>
...
<p>An IATA e-Certificate is awarded to participants successfully passing the final exam.</p><h3>Exam information</h3><a name="ExamInfo"></a> <p>Please read the <a href="http&#58;//www.iata.org/training/Pages/exam-information.aspx">General Information</a> on Self-study exams.</p><ul>
...
<li>Time Allowance&#58; 2 hours</li>
<li>Passing Grade&#58; 70% correct answers</li>
<li>Number of exam attempts&#58; 1</li>
</ul>
</span></span>
...
<li><a href="https://www.iata.org/training/subject-areas/Pages/travel-tourism-courses.aspx">Travel and tourism</a></li><li><a href="https://www.iata.org/training/subject-areas/Pages/fares-ticketing-courses.aspx">Fares and ticketing</a></li><li><a href="https://www.iata.org/training/subject-areas/Pages/finance-accounting-courses.aspx">Finance and accounting</a></li><li><a href="https://www.iata.org/training/subject-areas/Pages/sales-marketing-courses.aspx">Sales and marketing</a></li>
</ul>
</td>
</tr>
</table>
...
<tr>
<td><strong>Note: </strong><p>Customer service is important in the competitive travel industry, helping you successfully retain business, attract clients and foster positive agent-customer interactions. This eLearning course recommends practical ways to stay in touch with travelling customers and win customer loyalty.<span></span></p></td>
...
<td><strong><span id="ctl00_PlaceHolderMain_TabContainer1_TabPanel3_DistanceLearningDetails_EnrolLink"><INPUT type='button' value='Buy ebook' class='primaryBtn' onclick="window.open('http://training.iata.org/purchases/new?sitting_id=&product_id=717', '_blank')"></span><strong></td>
</tr>
</tbody>
</thead>
</table>
...
<div class='hide_element_6f0896a7-7ddc-4043-9738-deafaf29c87d'></div><script type='text/javascript'>CTP.IATA.HideChrome('6f0896a7-7ddc-4043-9738-deafaf29c87d')</script>
<div class='hide_element_f341b6f4-bdea-40db-a2f1-3b2007e506c9'></div><script type='text/javascript'>CTP.IATA.HideChrome('f341b6f4-bdea-40db-a2f1-3b2007e506c9')</script>
</div>
</div>
</div>
...
<script type="text/javascript">//<![CDATA[
        ...
        {
            formDigestElement.value = '0x993D1412482608DBD4FB0144A4EF5A94E68A2889C8EC20D3104254637CE0A450503923DD7AFEB0FA29E4092AEBE120F28A949B9426DCF54328A9F74EF2206B1B,27 Nov 2019 18:12:43 -0000';
...
{
    var initInfo = {editable: false,isEditMode: false,allowWebPartAdder: false,listId: "{0d58168f-feef-45ff-bc51-7b9336e39b71}",itemId: 1119901,recycleBinEnabled: true,enableMinorVersioning: true,enableModeration: false,forceCheckout: false,rootFolderUrl: "\u002ftraining\u002fcourses\u002fPages",itemPermissions:{High:16,Low:196673}};
