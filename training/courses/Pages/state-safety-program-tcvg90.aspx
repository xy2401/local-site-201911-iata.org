...
<meta name="keywords" content='State Safety Program, SSP, ICAO Standards and Recommended Practices, SARPs, ICAO Annex 19, Doc 9859, Safety Management Manual, SMM, regulation, administration, Acceptable Level of Safety
(ALoS) Performance, ALoSP, civil aviation, SSP
framework, State safety policy and objectives, State safety risk management, State safety assurance, State safety promotion, aviation, training, course' />
<meta name="description" content="<p>Learn how to develop, implement and maintain a State Safety Program (SSP) in compliance with the relevant ICAO Standards and Recommended Practices (SARPs),</p>" /><meta name="robots" content="FOLLOW,INDEX" /><title>
	
	State Safety Program (SSP) (Classroom, 5 days)  - IATA Training Course
...
<link rel="canonical" href="https://www.iata.org:443/training/courses/Pages/state-safety-program-tcvg90.aspx" />
...
var guaGmtGlobalRequestUri = "/training/courses/Pages/state-safety-program-tcvg90.aspx";
var guaGmtGlobalPageTitle = "TCVG-90";
...
'page' : {
'requestURI' : "/training/courses/Pages/state-safety-program-tcvg90.aspx",
'pageType' : "Home",
'device' : "Desktop",
...
<form method="post" action="./state-safety-program-tcvg90.aspx" id="aspnetForm">
...
<input type="hidden" name="__REQUESTDIGEST" id="__REQUESTDIGEST" value="0xCABF5546117500C549C1E41B8C9153AA56D2B4086D8AB28FF52AD62201BA14415D34C81637434C42C21B266CA7136B4DDF80FA0CBB06FE7CE3C5E2B0ADF6A9C6,27 Nov 2019 20:27:40 -0000" />
...
var _fV4UI=true;var _spPageContextInfo = {webServerRelativeUrl: "\u002ftraining\u002fcourses", webAbsoluteUrl: "https:\u002f\u002fwww.iata.org\u002ftraining\u002fcourses", siteAbsoluteUrl: "https:\u002f\u002fwww.iata.org", serverRequestPath: "\u002ftraining\u002fcourses\u002fPages\u002fstate-safety-program-tcvg90.aspx", layoutsUrl: "_layouts\u002f15", webTitle: "Search Courses", webTemplate: "10020", tenantAppVersion: "0", isAppWeb: false, Has2019Era: true, webLogoUrl: "\u002f_layouts\u002fimages\u002ftitlegraphic.gif", webLanguage: 1033, currentLanguage: 1033, currentUICultureName: "en-US", currentCultureName: "en-US", clientServerTimeDelta: new Date("2019-11-27T20:27:40.4789369Z") - new Date(), siteClientTag: "367$$15.0.5127.1000", crossDomainPhotosEnabled:false, webUIVersion:15, webPermMasks:{High:16,Low:196705},pageListId:"{0d58168f-feef-45ff-bc51-7b9336e39b71}",pageItemId:1105479, pagePersonalizationScope:1, alertsEnabled:true, siteServerRelativeUrl: "\u002f", allowSilverlightPrompt:'True'};document.onreadystatechange=fnRemoveAllStatus; function fnRemoveAllStatus(){removeAllStatus(true)};//]]>
</script>
...
<script language="javascript">
    ...
    function GACode() {
        ...
        _gaq.push(['_trackPageview', '/training/courses/Pages/state-safety-program-tcvg90.aspx?q=' + document.getElementById("SearchTextBox").value + '&cat=Main_Search']);
        */
        return true;
    }
...
<ul>
<li><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2Fpages%2Fstate-safety-program-tcvg90.aspx" id="ctl00_PlaceHolderMain_pageTools_linkFB" target="_blank" title="Share this Page"><span class="icon icon-facebook"></span></a></li>
...
<li><a href="//www.linkedin.com/shareArticle?mini=true&url=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2FPages%2Fstate-safety-program-tcvg90.aspx" id="ctl00_PlaceHolderMain_pageTools_linkLinkedIn" target="_blank"><span class="icon icon-linkedin"></span></a></li>
<li><a href="mailto:?subject=I wanted you to see this site&amp;body=Check out this site http://www.iata.org/training/courses/Pages/state-safety-program-tcvg90.aspx" id="ctl00_PlaceHolderMain_pageTools_linkMail" title="Share by Email"><span class="icon icon-enveloppeRound"></span></a></li>
</ul>
</div>
</div>
</div>
...
<span id="ctl00_PlaceHolderMain_cpMainContentTitle_ctl00_otherLanguageCourses_lblOtherCoureses"><a href='/training/courses/Pages/programa-seguridad-estado-tcvg90-es.aspx' target='_blank'>Este curso también está disponible en Español.</a><br /><a href='/training/courses/Pages/securite-etat-ssp-tcvg90-fr.aspx' target='_blank'>Ce cours est aussi disponible en Français.</a><br /><br /></span>
...
<span id="ctl00_PlaceHolderMain_TabContainer1_TabPanel1_trainingSocioEconomics_lblTrainingSocioEconomics">Did you know that in the past 3 years, <strong>193 participants from 25 countries </strong> have taken this course with IATA?<br /></span>
...
<p>Learn how to develop, implement and maintain a State Safety Program (SSP) in compliance with the relevant ICAO Standards and Recommended Practices (SARPs), namely ICAO Annex 19 and Doc 9859 Safety Management Manual (SMM).</p><p>An SSP is a management system for the regulation and administration of safety by the State, appropriate to the size and complexity of the State’s civil aviation system, in order to achieve an Acceptable Level of Safety (ALoS) Performance (ALoSP) in civil aviation. Gain an understanding of the four main components of an SSP framework&#58; State safety policy and objectives; State safety risk management; State safety assurance; and State safety promotion.</p><p>As part of its SSP, each State requires service providers under its authority to implement a Safety Management System (SMS) by which systemic safety deficiencies can be effectively identified and safety concerns can be resolved. States need to enact national laws and legislation to protect data gathered from safety data collection and processing systems (SDCPS). Appropriate coordination, integration and accessibility of their SSP-related safety databases needs to be established in States with multiple authorities responsible for safety regulation.</p><p> This course is available at <a href="/training/delivery/Pages/classroom-training-centers.aspx" target="_blank">IATA Training Centers</a>, <a href="/training/Pages/regional_training_centres.aspx" target="_blank">Regional Training Partner locations</a>, and on-demand as <a href="/training/delivery/Pages/in-company.aspx" target="_blank">in-company training</a>. </p>
...
<tr>
<td><span>Sep 21 - Sep 25, 2020 - Canada, Montreal (IATA, ACCET Accredited)</br></span><a href="http://training.iata.org/purchases/new?sitting_id=110678&product_id=3876" target="_blank"><img src="/events/Images1/buttons/register-button.png" alt="Register" style="margin:5px;"></a><br></td>
</tr>
</table>
</div>
</td>
...
<p>Upon completion of this course you will be able to&#58;</p><ul><li>Develop and implement an SSP in compliance with the relevant ICAO SARPs, including a harmonized regulatory framework for the oversight of product and service providers’ SMS</li><li>Ensure an operational SSP which requires specific functions performed by States, including the enactment of legislation, regulations, policies and directives to support the safe and efficient delivery of aviation products and services</li><li>Understand the need to establish and maintain a safety database that can be used to support a safety data analysis</li><li>Understand that safety is now data-driven and that the existing prescriptive approach to safety is expanded and complemented with a performance-based approach<span></span></li></ul>
</span></span>
...
<ul><li> SSP and SMS requirements
<ul><li>The need for the development of the SSP</li><li>SSP as the bridge between the safety processes of the State and the service provider</li></ul></li><li>ICAO Annex 19 contents and future amendments</li><li>Doc 9859 Safety Management Manual contents and guidance on the SSP and SMS</li><li>SSP objectives, requirements and implementation</li><li>ICAO SSP framework
<ul><li>State safety policy and objectives</li><li>State safety risk management, safety assurance</li><li>State safety promotion</li></ul></li><li>The 4-phased approach to SSP implementation</li><li>SSP reporting and performance measurements</li><li>Acceptable Level of Safety (ALoS) and ALoS Performance (ALoSP)<ul><li>Safety Performance Measurement (SPM)</li></ul></li><li>Safety databases to support safety data analysis</li><li>SSP protection of safety data, safety information and related sources</li><li>SSP and the airline ALoSP<span></span></li></ul><p>
<a href="/training/courses/Pages/download-file.aspx?documentName=/training-tcvg90-state-safety-program.pdf&amp;documentID=900" target="_blank"><img src="/training/Icons/dwnl_outline.png" alt="Download the course outline" /></a>
</p>
</span></span>
...
<p>This course is recommended for&#58;</p><ul><li>Government, CAA and NAA personnel</li><li>Service providers responsible for the Safety Management System within their organization<span></span></li></ul>
</span></span>
...
<li><a href="https://www.iata.org/training/subject-areas/Pages/civil-aviation-courses.aspx">Civil Aviation Authorities</a></li><li><a href="https://www.iata.org/training/subject-areas/Pages/law-regulations-courses.aspx">Law and regulations</a></li><li><a href="https://www.iata.org/training/subject-areas/Pages/safety-courses.aspx">Safety</a></li>
</ul>
</td>
</tr>
</table>
...
<a href='http://training.iata.org/purchases/new?sitting_id=110678&product_id=3876' style='float:right;' class='primaryBtn' target='_blank'> Register </a>
</td>
</tr>
...
<td></td>
<td colspan="3" class="gray">
<a href='http://training.iata.org/purchases/new?sitting_id=110676&product_id=3876' style='float:right;' class='primaryBtn' target='_blank'> Register </a>
</td>
</tr>
<tr sizset="61" sizcache="8">
<td sizset="61" sizcache="8" colspan="2">
...
<td></td>
<td colspan="3" class="gray">
<a href='http://training.iata.org/purchases/new?sitting_id=110675&product_id=3876' style='float:right;' class='primaryBtn' target='_blank'> Register </a>
</td>
</tr>
<tr sizset="61" sizcache="8">
<td sizset="61" sizcache="8" colspan="2">
...
<div class='hide_element_d167d176-fc93-4bd6-9f3b-9d33f984f610'></div><script type='text/javascript'>CTP.IATA.HideChrome('d167d176-fc93-4bd6-9f3b-9d33f984f610')</script>
<div class='hide_element_cfb7571a-7d94-4fef-b333-979aa6ac8151'></div><script type='text/javascript'>CTP.IATA.HideChrome('cfb7571a-7d94-4fef-b333-979aa6ac8151')</script>
</div>
</div>
</div>
...
<script type="text/javascript">//<![CDATA[
        ...
        {
            formDigestElement.value = '0x104221DBF75AFEE2B8FD55E04CEBE5CB1CAD678BFAAF58F7FE8FD0FF4AC1B017933333A5F9ED026E1D468AE884AEAFC1A0755A149B80B3E1BB3CBD63536B8B61,27 Nov 2019 20:27:42 -0000';
...
{
    var initInfo = {editable: false,isEditMode: false,allowWebPartAdder: false,listId: "{0d58168f-feef-45ff-bc51-7b9336e39b71}",itemId: 1105479,recycleBinEnabled: true,enableMinorVersioning: true,enableModeration: false,forceCheckout: false,rootFolderUrl: "\u002ftraining\u002fcourses\u002fPages",itemPermissions:{High:16,Low:196673}};
