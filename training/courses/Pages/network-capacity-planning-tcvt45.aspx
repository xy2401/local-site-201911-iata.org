...
<meta name="keywords" content='eurocontrol, aviation, training, course, aeronautical, airspace, caa, atc, planning, network, ansp' />
<meta name="description" content="<p>This course starts with an overview of the regulatory background and then explores the various steps of the capacity planning process.</p>" /><meta name="robots" content="FOLLOW,INDEX" /><title>
	
	Network Capacity Planning (ASM-CAP) - with the EUROCONTROL Institute of ANS  - IATA Training Course
...
<link rel="canonical" href="https://www.iata.org:443/training/courses/Pages/network-capacity-planning-tcvt45.aspx" />
...
var guaGmtGlobalRequestUri = "/training/courses/Pages/network-capacity-planning-tcvt45.aspx";
var guaGmtGlobalPageTitle = "TCVT-45";
...
'page' : {
'requestURI' : "/training/courses/Pages/network-capacity-planning-tcvt45.aspx",
'pageType' : "Home",
'device' : "Desktop",
...
<form method="post" action="./network-capacity-planning-tcvt45.aspx" id="aspnetForm">
...
<input type="hidden" name="__REQUESTDIGEST" id="__REQUESTDIGEST" value="0x87752B0688E3302494923730DA39D721AD0B2717609EE5F0A9FD6493AB2188DDD322024435F86E2208DD789D91CFBCDF2139B6185EB8506B6A7A81C4206955D1,27 Nov 2019 18:08:57 -0000" />
...
var _fV4UI=true;var _spPageContextInfo = {webServerRelativeUrl: "\u002ftraining\u002fcourses", webAbsoluteUrl: "https:\u002f\u002fwww.iata.org\u002ftraining\u002fcourses", siteAbsoluteUrl: "https:\u002f\u002fwww.iata.org", serverRequestPath: "\u002ftraining\u002fcourses\u002fPages\u002fnetwork-capacity-planning-tcvt45.aspx", layoutsUrl: "_layouts\u002f15", webTitle: "Search Courses", webTemplate: "10020", tenantAppVersion: "0", isAppWeb: false, Has2019Era: true, webLogoUrl: "\u002f_layouts\u002fimages\u002ftitlegraphic.gif", webLanguage: 1033, currentLanguage: 1033, currentUICultureName: "en-US", currentCultureName: "en-US", clientServerTimeDelta: new Date("2019-11-27T18:08:57.7164993Z") - new Date(), siteClientTag: "367$$15.0.5127.1000", crossDomainPhotosEnabled:false, webUIVersion:15, webPermMasks:{High:16,Low:196705},pageListId:"{0d58168f-feef-45ff-bc51-7b9336e39b71}",pageItemId:878357, pagePersonalizationScope:1, alertsEnabled:true, siteServerRelativeUrl: "\u002f", allowSilverlightPrompt:'True'};document.onreadystatechange=fnRemoveAllStatus; function fnRemoveAllStatus(){removeAllStatus(true)};//]]>
</script>
...
<script language="javascript">
    ...
    function GACode() {
        ...
        _gaq.push(['_trackPageview', '/training/courses/Pages/network-capacity-planning-tcvt45.aspx?q=' + document.getElementById("SearchTextBox").value + '&cat=Main_Search']);
        */
        return true;
    }
...
<ul>
<li><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2Fpages%2Fnetwork-capacity-planning-tcvt45.aspx" id="ctl00_PlaceHolderMain_pageTools_linkFB" target="_blank" title="Share this Page"><span class="icon icon-facebook"></span></a></li>
...
<li><a href="//www.linkedin.com/shareArticle?mini=true&url=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2FPages%2Fnetwork-capacity-planning-tcvt45.aspx" id="ctl00_PlaceHolderMain_pageTools_linkLinkedIn" target="_blank"><span class="icon icon-linkedin"></span></a></li>
<li><a href="mailto:?subject=I wanted you to see this site&amp;body=Check out this site http://www.iata.org/training/courses/Pages/network-capacity-planning-tcvt45.aspx" id="ctl00_PlaceHolderMain_pageTools_linkMail" title="Share by Email"><span class="icon icon-enveloppeRound"></span></a></li>
</ul>
</div>
</div>
</div>
...
<p>A capacity planning process has been implemented for more than decade and it has been recently re-enforced through the creation of the Network Manager and the implementation of the European Performance Scheme. In order to apply a consolidated and harmonised process network-wide, all involved stakeholders have to fully understand the details and the various steps of the capacity planning process and its supporting tools and data. Understanding and implementing these mechanisms is essential to improve operational performance at local and network level. This course starts with an overview of the regulatory background and then explores the various steps of the capacity planning process. The last part of the course provides in-depth knowledge about NEST, one of the main tools provided by EUROCONTROL to support network operations planning.</p><p>This course is delivered by the <a href="https&#58;//trainingzone.eurocontrol.int/" target="_blank">EUROCONTROL Training Institute</a>.<br></p>
<h3>Course format</h3><ul>
<li>This classroom course provides 4 days of instruction</li>
</ul><h3>Prerequisites </h3><ul>
<li>Participants should have basic knowledge of airspace structure and ACC operational aspects.</li>
</ul>
</span></span>
...
<p>This course enables stakeholders to understand and perform the capacity planning process and to see how this ensures a harmonised network integration.</p>
</span></span>
...
<p>This course is recommended for&#58;</p><ul><li>Operational/strategic planning units from ANSPs (ACC staff, HQ staff), NSAs and FAB teams.<span></span></li></ul>
</span></span>
...
<p>All candidates will receive a certificate of attendance.</p>
 </span></span>
...
<div class='hide_element_8f57af6f-ab1b-4669-be0b-1f7201fb8cf4'></div><script type='text/javascript'>CTP.IATA.HideChrome('8f57af6f-ab1b-4669-be0b-1f7201fb8cf4')</script>
<div class='hide_element_e1a9c230-f2ae-486e-be57-24f8b0e1509f'></div><script type='text/javascript'>CTP.IATA.HideChrome('e1a9c230-f2ae-486e-be57-24f8b0e1509f')</script>
</div>
</div>
</div>
...
<script type="text/javascript">//<![CDATA[
        ...
        {
            formDigestElement.value = '0xB0C6E8357247DFB4280155ED73984B85B9C919E31E5B0BA32E24C8B7EBD55D69AF0B840C5386D68EB12178AC44F15D05666CA73E2BE87DFFD4ABB233387FAD98,27 Nov 2019 18:08:58 -0000';
...
{
    var initInfo = {editable: false,isEditMode: false,allowWebPartAdder: false,listId: "{0d58168f-feef-45ff-bc51-7b9336e39b71}",itemId: 878357,recycleBinEnabled: true,enableMinorVersioning: true,enableModeration: false,forceCheckout: false,rootFolderUrl: "\u002ftraining\u002fcourses\u002fPages",itemPermissions:{High:16,Low:196673}};
