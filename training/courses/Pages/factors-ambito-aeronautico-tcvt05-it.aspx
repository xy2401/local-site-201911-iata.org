...
<meta name="keywords" content='dell’errore umano, Comunicazione efficace, safety culture, e l’efficienza,  Limitazioni delle performance, gestire la stanchezza e lo stress,' />
<meta name="description" content="<p>La disciplina degli ‘Human Factors’ comprende tutti i metodi per comprendere il comportamento e migliorare la performance degli esseri umani.</p>" /><meta name="robots" content="FOLLOW,INDEX" /><title>
	
	Human Factors in Aviation - Italian (Classroom, 5 days)  - IATA Training Course
...
<link rel="canonical" href="https://www.iata.org:443/training/courses/Pages/factors-ambito-aeronautico-tcvt05-it.aspx" />
...
var guaGmtGlobalRequestUri = "/training/courses/Pages/factors-ambito-aeronautico-tcvt05-it.aspx";
...
'page' : {
'requestURI' : "/training/courses/Pages/factors-ambito-aeronautico-tcvt05-it.aspx",
'pageType' : "Home",
'device' : "Desktop",
...
<form method="post" action="./factors-ambito-aeronautico-tcvt05-it.aspx" id="aspnetForm">
...
<input type="hidden" name="__REQUESTDIGEST" id="__REQUESTDIGEST" value="0x8811669FE952178392A0398732CCEB80F92A650774420A0DD28582F7C0772959606A76D654329C7E6E8B1271D3C3209B3C4C55C890BB6E1C7A1975D2C7447F4D,27 Nov 2019 18:08:48 -0000" />
...
var _fV4UI=true;var _spPageContextInfo = {webServerRelativeUrl: "\u002ftraining\u002fcourses", webAbsoluteUrl: "https:\u002f\u002fwww.iata.org\u002ftraining\u002fcourses", siteAbsoluteUrl: "https:\u002f\u002fwww.iata.org", serverRequestPath: "\u002ftraining\u002fcourses\u002fPages\u002ffactors-ambito-aeronautico-tcvt05-it.aspx", layoutsUrl: "_layouts\u002f15", webTitle: "Search Courses", webTemplate: "10020", tenantAppVersion: "0", isAppWeb: false, Has2019Era: true, webLogoUrl: "\u002f_layouts\u002fimages\u002ftitlegraphic.gif", webLanguage: 1033, currentLanguage: 1033, currentUICultureName: "en-US", currentCultureName: "en-US", clientServerTimeDelta: new Date("2019-11-27T18:08:48.6528921Z") - new Date(), siteClientTag: "367$$15.0.5127.1000", crossDomainPhotosEnabled:false, webUIVersion:15, webPermMasks:{High:16,Low:196705},pageListId:"{0d58168f-feef-45ff-bc51-7b9336e39b71}",pageItemId:1173092, pagePersonalizationScope:1, alertsEnabled:true, siteServerRelativeUrl: "\u002f", allowSilverlightPrompt:'True'};document.onreadystatechange=fnRemoveAllStatus; function fnRemoveAllStatus(){removeAllStatus(true)};//]]>
</script>
...
<script language="javascript">
    ...
    function GACode() {
        ...
        _gaq.push(['_trackPageview', '/training/courses/Pages/factors-ambito-aeronautico-tcvt05-it.aspx?q=' + document.getElementById("SearchTextBox").value + '&cat=Main_Search']);
        */
        return true;
    }
...
<ul>
<li><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2Fpages%2Ffactors-ambito-aeronautico-tcvt05-it.aspx" id="ctl00_PlaceHolderMain_pageTools_linkFB" target="_blank" title="Share this Page"><span class="icon icon-facebook"></span></a></li>
...
<li><a href="//www.linkedin.com/shareArticle?mini=true&url=http%3A%2F%2Fwww.iata.org%2Ftraining%2Fcourses%2FPages%2Ffactors-ambito-aeronautico-tcvt05-it.aspx" id="ctl00_PlaceHolderMain_pageTools_linkLinkedIn" target="_blank"><span class="icon icon-linkedin"></span></a></li>
<li><a href="mailto:?subject=I wanted you to see this site&amp;body=Check out this site http://www.iata.org/training/courses/Pages/factors-ambito-aeronautico-tcvt05-it.aspx" id="ctl00_PlaceHolderMain_pageTools_linkMail" title="Share by Email"><span class="icon icon-enveloppeRound"></span></a></li>
</ul>
</div>
</div>
</div>
...
<p>La disciplina degli ‘Human Factors’ comprende tutti i metodi per comprendere il comportamento e migliorare la performance degli esseri umani. L’applicazione dei principi Human Factors nell’ambito operativo di dominio aeronautico si propone di ottimizzare gli ambienti lavorativi a partire dalle caratteristiche ed esigenze delle persone che li popolano, con il fine ultimo di massimizzare il rendimento umano e la sicurezza delle operazioni.</p><p>‘Human Factors in Aviation’ è un corso idoneo ad ogni profilo professionale e non richiede specifiche competenze pregresse nell’ambito trattato. Il corso offre una panoramica completa sul vasto mondo ‘Human Factors’ e sulle sue applicazioni pratiche in ambito aeronautico. Al suo termine, potrai scegliere di proseguire con corsi più specifici su Fatigue Risk Management Systems (FRMS), Threat and Error Management (TEM), Crew Resource Management (CRM) e Team Resource Management (TRM).</p>
</span></span>
<h3></h3>
...
<p><strong>Obiettivi</strong></p><p>Al termine del corso&#58;</p><ul><li>Conoscerai in maniera approfondita la storia, i metodi e le principali applicazioni Human Factors in ambito aeronautico</li><li>Avrai acquisito nuove abilità decisionali e sociali che miglioreranno la tua capacità gestionale dell’errore umano (sia proattiva che reattiva)</li><li>Sarai quindi in grado di contribuire attivamente alla safety e all’efficienza, miglioramento il contributo umano su entrambi i fronti.</li><li>Sarai in grado di selezionare gli strumenti e le
attività HF migliori per ciascun problema</li></ul>
</span></span>
...
<p><strong>I contenuti del corso</strong></p><ul><li><span></span>Human Factors e Business Performance</li><li>ICAO’s Human Factors e Safety Management System (SMS)</li><li>Storia e definizioni di Human Factors</li><li>Modelli di analisi Human Factors&#58; modello Software, Hardware, Environment and Liveware (SHEL); teoria dell’errore di Reason; Human Factors Analysis &amp; Classification System (HFACS)</li><li>La prestazione umana&#58; abilità e limiti</li><li>Modalità per gestire la stanchezza e lo stress</li><li>Metodi di comprensione e analisi del comportamento umano</li><li>Modelli e metodi per l’analisi dell’errore umano</li><li>Threat and Error Management (TEM)</li><li>Applicazione dei principi Human Factors a situazioni operative&#58; CRM e TRM</li><li>Comunicazione efficace</li><li>Gestione delle competenze e competenze chiave.<span></span></li></ul><p>
<strong><a href="/training/courses/Pages/download-file.aspx?documentName=training-tcvt05it-human-factors-aviation-italian.pdf&amp;documentID=971" target="_blank">scaricare la scheda completa</a></strong>
</p><strong>Attività</strong><ul><li>Esercitazioni e applicazioni pratiche dei metodi
Human Factors, su casi studio e su problemi proposti dai partecipanti</li><li>Esame scritto finale<span></span></li></ul>
</span></span>
...
<p><strong>Destinatari del corso</strong></p><ul><li>Qualsiasi persona operante nel settore aeronautico, con specifico riferimento al personale che ricopre ruoli safety-critical o di gestione delle operazioni</li><li>Piloti, membri dell’equipaggio di bordo, managers di compagnie aeree e personale operativo</li><li>Controllori del traffico aereo e managers di ANSP</li><li>Autorità dell’aviazione civile</li><li>Personale e managers di società di manutenzione (velivoli e aeroporti)</li><li>Personale e managers di società aereoportuali<span></span></li></ul>
</span></span>
...
<div class='hide_element_ffe58e29-92d3-4e99-8ef2-51583cb908ca'></div><script type='text/javascript'>CTP.IATA.HideChrome('ffe58e29-92d3-4e99-8ef2-51583cb908ca')</script>
<div class='hide_element_93ac8a44-cc87-417d-b200-cbb5a827d6d6'></div><script type='text/javascript'>CTP.IATA.HideChrome('93ac8a44-cc87-417d-b200-cbb5a827d6d6')</script>
</div>
</div>
</div>
...
<script type="text/javascript">//<![CDATA[
        ...
        {
            formDigestElement.value = '0xF85923FF375AAF1EC243EF57122886B2662DE4A3392EEA0736B58C883635E539D27EECC33E159C6F135D545AF740A076397CE60B56A3022660DD231D1A36B41B,27 Nov 2019 18:08:49 -0000';
...
{
    var initInfo = {editable: false,isEditMode: false,allowWebPartAdder: false,listId: "{0d58168f-feef-45ff-bc51-7b9336e39b71}",itemId: 1173092,recycleBinEnabled: true,enableMinorVersioning: true,enableModeration: false,forceCheckout: false,rootFolderUrl: "\u002ftraining\u002fcourses\u002fPages",itemPermissions:{High:16,Low:196673}};
