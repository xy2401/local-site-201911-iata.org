...
<a href="/publications/store/Documents/Passenger%20Standards/ssim-table-of-contents.pdf" target="_blank">View the SSIM table of contents</a>&#160;(pdf)</p><h2>New SSIM Standards and What's Planned<br></h2><p>The new MCT chapter 8 standardizes the transmission, application and processing of MCT data for airlines and their business partners for communicating and connection building.<br></p><p>It is planned to define XML formats and standardize the communication of full MCT data sets and changes to the data sets.</p><div class="zHighlight"><div class="zHighlightBox"><h2>Industry Cutover 26OCT2019. Be Ready to Connect!<br></h2>
<br>
